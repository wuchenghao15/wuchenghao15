...
class PathFixer {
    constructor() {
        this.projectRoot = process.cwd().catch(error => console.error(`[path-fixer.js] process.cwd failed:`, error));
    ...
    copyDir(src, dest) {
        ...
        for (const entry of entries) {
            ...
            if (entry.isDirectory().catch(error => console.error(`[path-fixer.js] entry.isDirectory failed:`, error))) {
    ...
    generateReport() {
        ...
        const htmlFiles = this.getHtmlFiles().catch(error => console.error(`[path-fixer.js] this.getHtmlFiles failed:`, error));
    ...
    async run() {
        ...
        // 创建备份
        this.createBackup().catch(error => console.error(`[path-fixer.js] this.createBackup failed:`, error));
        
        // 生成报告
        const report = this.generateReport().catch(error => console.error(`[path-fixer.js] this.generateReport failed:`, error));
