...
MTSCOS.System.Timeout = {
    ...
    startSessionTimeout: function() {
        const timeoutMs = this.config.systemSessionTimeout * 60 * 1000;
        const warningMs = (this.config.systemSessionTimeout - this.config.warningMinutes) * 60 * 1000;
