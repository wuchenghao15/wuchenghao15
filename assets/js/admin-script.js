...
class AdminManager {
    ...
    addNewModule() {
        ...
        if (moduleName) {
            const moduleId = moduleName.toLowerCase().catch(error => console.error(`[admin-script.js] moduleName.toLowerCase failed:`, error)).replace(/\s+/g, '-');
    ...
    initTerminal() {
        ...
        terminalInput.addEventListener('keydown', async (e) => {
            if (e.key === 'Enter' && !this.isProcessingTerminal) {
                const command = terminalInput.value.trim().catch(error => console.error(`[admin-script.js] value.trim failed:`, error));
                if (command) {
                    // 保存到历史记录
                ...
                e.preventDefault().catch(error => console.error(`[admin-script.js] e.preventDefault failed:`, error));
                // 历史记录导航
        ...
        document.getElementById('clear-terminal')?.addEventListener('click', () => {
            ...
            terminalInput.focus().catch(error => console.error(`[admin-script.js] terminalInput.focus failed:`, error));
        });
    }
