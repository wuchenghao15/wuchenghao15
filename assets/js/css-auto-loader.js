...
class CssAutoLoader {
  ...
  console.error(`[css-auto-loader.js] determineBasePath failed:`, error);
}
  ...
  console.error(`[css-auto-loader.js] detectDarkMode failed:`, error);
}
        this.loadedStyles = new Set();
        try {
  this.themeColors = this.getThemeColors();
} catch (error) {
  console.error(`[css-auto-loader.js] getThemeColors failed:`, error);
}
  ...
  console.error(`[css-auto-loader.js] applyTheme failed:`, error);
}
...
try {
  ...
  console.error(`[css-auto-loader.js] getCurrentPageName failed:`, error);
}
  ...
  console.error(`[css-auto-loader.js] loadDefaultThemes failed:`, error);
}
  ...
  console.error(`[css-auto-loader.js] setupThemeListener failed:`, error);
}
  ...
  console.error(`[css-auto-loader.js] setupSystemThemeListener failed:`, error);
}
  ...
  console.error(`[css-auto-loader.js] setupResponsiveListeners failed:`, error);
}
