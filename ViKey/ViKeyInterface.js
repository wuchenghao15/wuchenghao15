...
function ViKeySocketInterface()
{
	...
	{
		this.ViKeySocket = new MozWebSocket(url);
	} 
	else 
	{
    ...
    this.VikeyGetCurrentPcChkData = function(index) 
	{
		try
		{
			var msg = 
			{
				FunctionType: "VikeyGetCurrentPcChkData",
				Index: index
			};
			this.ViKeySocket.send('255|ViKeyWebSocket|'+JSON.stringify(msg));
			return true;
    ...
    this.VikeySetPcChkData = function(index, ChkData) 
	{
		try
		{
			var msg = 
			{
				FunctionType: "VikeySetPcChkData",
				Index: index,
				ChkData: ChkData
			};
			this.ViKeySocket.send('255|ViKeyWebSocket|'+JSON.stringify(msg));
    ...
    this.VikeyIsThisPc = function(index) 
	{
		try
		{
			var msg = 
			{
				FunctionType: "VikeyIsThisPc",
				Index: index
			};
			this.ViKeySocket.send('255|ViKeyWebSocket|'+JSON.stringify(msg));
			return true;
    ...
    this.VikeyClearPcChkData = function(index) 
	{
		try
		{
			var msg = 
			{
				FunctionType: "VikeyClearPcChkData",
				Index: index
			};
			this.ViKeySocket.send('255|ViKeyWebSocket|'+JSON.stringify(msg));
			return true;
