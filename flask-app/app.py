#!/usr/bin/env python3
r"""MTSCOS AI Project Main Applicationr"""
...
try:
    ...
    sys.stderr.write(fr"[WARN] db_path patch failed: {_e}\n")

# _path_setup.py 已归档至 _config/，注入 _config 目录后再 import
_config_dir = os.path.join(_BASE_DIR, r'_config')
if _config_dir not in sys.path:
    sys.path.insert(0, _config_dir)

import _path_setup

print(f"[DEBUG START] app.py started at {time.strftime(r'%Y-%m-%d %H:%M:%S')}")
