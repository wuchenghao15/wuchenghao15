...
def init_question_generator_config():
    ...
    try:
        ...
        configs = [
            ...
            ("supported_languages", str(["japanese", "english", "chinese"]), "json", "支持的语言列表", 1),
            ("supported_categories", str(["词汇", "语法", "阅读", "听力", "写作", "口语", "翻译"]), "json", "支持的题目类别", 1),
            ("supported_difficulties", str([1, 2, 3, 4, 5]), "json", "支持的难度等级", 1),
            ("supported_question_types", str(["single", "multiple", "fill", "short_answer", "essay", "speaking", "translation"]), "json", "支持的题目类型", 1),
