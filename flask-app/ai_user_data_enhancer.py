...
class AIUserDataEnhancer:
    ...
    def get_user_test_results(self, username, language):
        ...
        cursor.execute("""
            SELECT score, total_questions, correct_answers, completion_time, timestamp
            FROM test_results 
    ...
    def update_user_level_based_on_tests(self, username, language):
        ...
        current_level = current_level_record[2]  # level字段
        highest_level = current_level_record[3]  # highest_level字段
