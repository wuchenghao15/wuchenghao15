...
class PermissionManager:
    ...
    def get_permission(self, path: str, user_id: str) -> Dict[str, bool]:
        ...
        try:
            # 检查是否有直接权限设置
            if path in self._permissions and user_id in self._permissions[path]:
    ...
    def add_user_to_group(self, user_id: str, group_id: str) -> bool:
        ...
        try:
            ...
            # 组权限存储为特殊的权限设置
            self._permissions[group_key][user_id] = {'in_group': True}
