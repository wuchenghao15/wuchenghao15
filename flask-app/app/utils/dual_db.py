    ...
    def _copy_table_structure(self, table):
        ...
        if self.primary_db.db_type == 'sqlite':
            ...
            for col in columns:
                ...
                col_def = f"{col_name} {col_type} {not_null} {default} {primary_key}"
