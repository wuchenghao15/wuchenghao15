...
def ai_brain_root():
    ...
    return jsonify({
        ...
        'endpoints': [
            ...
            '/api/ai-brain/exam',
            '/api/ai-brain/status',
            '/api/ai-brain/validate-knowledge/<knowledge_id>',
            '/api/ai-brain/validate-knowledge/batch',
            '/api/ai-brain/validation-report',
            '/api/ai-brain/knowledge-by-status/<status>'
        ]
    })
