        ...
        if language == "japanese":
            if category == "日常对话":
                questions = [
                    ...
                    {
                        "content": "今日はいい天気ですね。",
                        "options": ["はい、そうですね。", "いいえ、ちがいます。", "おはようございます。", "おやすみなさい。"],
                ...
                questions = [
                    {
                        ...
                        "options": ["1000円です。", "はい、そうです。", "いいえ、ちがいます。", "わかりました。"],
                ...
                questions = [
                    {
                        ...
                        "explanation": "This is a common English greeting asking about someone's well-being.",
                        "type": "multiple_choice"
                    },
                    {
                        "content": "Excuse me, where is the restroom?",
                        "options": ["Yes, it is.", "No, it isn't.", "Over there.", "I see."],
                        "correct_answer": "Over there.",
                        "explanation": "This is a question asking for directions to the restroom.",
                        "type": "multiple_choice"
                    }
                ]
            else:
                questions = [
                    {
                        ...
                        "options": ["$10.", "Yes, it is.", "No, it isn't.", "I understand."],
                        "correct_answer": "$10.",
                        "explanation": "This is a question asking about the price of a product.",
                        "type": "multiple_choice"
                    }
                ]
