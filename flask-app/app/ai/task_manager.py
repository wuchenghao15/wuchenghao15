...
class TaskManager:
    ...
    def publish_task(self, task_type: str, task_data: Dict[str, Any], priority: int = 0) -> str:
        """
        发布任务
    ...
    def _process_model_training(self, task_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        处理模型训练任务
...
task_manager = TaskManager(cluster_manager)
