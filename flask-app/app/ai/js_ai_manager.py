...
const JSAPIAI = {
    ...
    sendAIAnalysis: async function(data, type) {
        return this.fetchAPI('/api/ai/analyze', {
            method: 'POST',
            body: { data, type }
        });
    }
