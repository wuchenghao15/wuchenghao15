...
class ErrorCaseCollector:
    ...
    def _generate_solution(self, exception: Exception, context: Dict[str, Any] = None) -> str:
        ...
        solutions = {
            ...
            'PermissionError': "确保应用程序具有足够的权限访问文件或目录",
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        try:
            stats = {
                ...
                'cases_by_type': {},
                'recent_cases': self.error_cases[-10:],
                'last_updated': datetime.now().isoformat()
            }
            
            # 按错误类型统计
            for case in self.error_cases:
                error_type = case['title'].split('异常:')[0]
...
try:
    ...
    error_case_collector = ErrorCaseCollector()
...
if __name__ == '__main__':
    ...
    print(f"测试后错误案例数量: {len(error_case_collector.error_cases)}")
