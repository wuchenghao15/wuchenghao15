...
class EnhancedAIService:
    ...
    def get_enhanced_ai_employee(self, employee_id):
        """获取加强版AI员工"""
        try:
            return EnhancedAIEmployee.get_by_id(employee_id)
        except Exception as e:
    ...
    def get_all_enhanced_ai_employees(self):
        """获取所有加强版AI员工"""
        try:
            return EnhancedAIEmployee.get_all()
        except Exception as e:
    ...
    def integrate_with_brain(self, employee_id):
        ...
        try:
            ...
            knowledge_content = f"AI员工名称: {ai_employee.name}\n类型: {ai_employee.ai_type}\n描述: {ai_employee.description}\n能力: {', '.join(ai_employee.capabilities)}"
        ...
        try:
            ...
            for knowledge in system_knowledge:
                ...
                if "配置" in knowledge.content or "设置" in knowledge.content:
                    ...
                    ai_employee.config["system_adaptation"] = {
                        "enabled": True,
