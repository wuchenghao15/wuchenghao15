    ...
    try:
        ...
        for column, data_type in new_columns.items():
            if column not in existing_columns:
                try:
                    cursor.execute(f"ALTER TABLE questions ADD COLUMN {column} {data_type}")
                    print(f"添加列: {column}")
        ...
        math_questions = [
            ...
            ("数学", "解析几何", "高中数学", "高考", "圆的标准方程是", "multiple_choice", 5, "(x-a)² + (y-b)² = r²", "x² + y² = r,x + y = r,x² - y² = r²", "圆心为(a,b)，半径为r的圆的标准方程"),
            # 大学
        ...
        chemistry_questions = [
            ...
            ("化学", "反应", "九年制进阶", "九年义务教育", "铁在氧气中燃烧生成", "multiple_choice", 3, "四氧化三铁", "氧化铁,氧化亚铁,氢氧化铁", "3Fe + 2O₂ = Fe₃O₄"),
            # 高中
        ...
        biology_questions = [
            # 九年制
            ("生物", "细胞", "九年制基础", "九年义务教育", "细胞的基本结构包括", "multiple_choice", 2, "细胞膜、细胞质、细胞核", "细胞壁、细胞膜、细胞质,细胞核、叶绿体、线粒体,细胞质、液泡、细胞壁", "动物细胞基本结构"),
            # 高中
        ...
        history_questions = [
            ...
            # 高中
            ("历史", "世界史", "高中历史", "高考", "文艺复兴运动起源于", "multiple_choice", 4, "意大利", "法国,英国,德国", "14世纪起源于意大利"),
        ]
        ...
        computer_questions = [
            ...
            # 大学
            ("计算机", "数据结构", "大学计算机", "大学", "栈(Stack)的特点是", "multiple_choice", 7, "先进后出", "先进先出,随机访问,顺序存储", "栈是后进先出(LIFO)的数据结构"),
        ]
        ...
        for q in all_questions:
            ...
            # 获取或创建分类ID
            cursor.execute("SELECT id FROM question_categories WHERE name = ?", (topic,))
