...
class QuestionBankUpdater:
    ...
    def add_question_bank(self, name, description, language_id):
        """添加题库"""
        sql = """
        INSERT OR IGNORE INTO question_banks (name, description, language_id, created_at, updated_at)
    ...
    def update_question_banks(self):
        ...
        # 添加英语题库
        self.add_question_bank("English Math Bank", "English math questions of various difficulty levels", en_id)
    ...
    def update_questions(self):
        ...
        english_vocabulary_questions = [
            ...
            {
                "content": "Which word means 'to give money in exchange for goods or services'?",
                "answer": "Buy",
        ...
        japanese_vocabulary_questions = [
            ...
            },
            {
                "content": "'水'は何の意味ですか？",
                "answer": "Water",
                "explanation": "'水'は英語で'Water'といいます",
                "category_id": japanese_id,
                "language_id": ja_id,
                "level_id": elementary_id,
                "question_type": "single_choice",
        ...
        # 合并所有问题
        all_questions = math_questions + english_questions + japanese_questions + \
