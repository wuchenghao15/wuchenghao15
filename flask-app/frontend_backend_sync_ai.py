    ...
    def restore_system_parameters(self):
        ...
        try:
            ...
            if latest_backup:
                ...
                logger.info("⚠️  没有找到系统参数备份")
                return {'status': 'ok', 'message': '没有找到系统参数备份'}
    ...
    def store_system_parameters(self):
        ...
        try:
            ...
            system_params = [
                ...
                ('backend_api_url', 'http://localhost:5001/api', '后端API基础URL'),
            ...
            logger.info(f"✅ 成功存储 {stored_count} 个系统参数")
        ...
        try:
            ...
            error_cases = [
                ...
                },
                {
                    ...
                    "solution": "检查数据库存储空间和权限，确保有足够的空间和权限进行备份",
                ...
                },
                {
                    ...
                    "title": "系统参数恢复失败",
                    "description": "系统参数恢复失败，可能是备份文件不存在或损坏",
...
def main():
    ...
    logger.info(f"存储结果: {results['store_result']}")
