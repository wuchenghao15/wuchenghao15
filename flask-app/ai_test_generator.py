...
TYPE_GENERATORS = {
    'int': lambda: (-1000 + secrets.randbelow(int(1000) - int(-1000) + 1)),
    'str': lambda: ''.join(random.choices(string.ascii_letters + string.digits, k=(0 + secrets.randbelow(int(20) - int(0) + 1)))),
    'str': lambda: ''.join(random.choices(string.ascii_letters + string.digits, k=(0 + secrets.randbelow(int(20) - int(0) + 1)))),
    'bool': lambda: secrets.choice([True, False]),
    'list': lambda: [(0 + secrets.randbelow(int(100) - int(0) + 1)) for _ in range((0 + secrets.randbelow(int(10) - int(0) + 1)))],
...
def generate_value_by_type(type_hint: str = None) -> Any:
    ...
    if type_hint is None:
        return secrets.choice([
            (-100 + secrets.randbelow(int(100) - int(-100) + 1)),
