...
class AutoVersionUpgrader:
    ...
    def save_config(self, config):
        ...
        try:
            ...
            logger.info(f"已保存版本配置到 {self.version_config_file}")
        except Exception as e:
    ...
    def update_config_version(self, config_file, current_version, new_version):
        """更新配置文件中的版本号"""
        logger.info(f"更新配置文件版本: {config_file}")
        ...
        try:
            ...
            if new_content != content:
                with open(config_file, 'w') as f:
                    f.write(new_content)
                logger.info(f"已更新配置文件 {config_file} 中的版本号")
        except Exception as e:
    ...
    def generate_version_changelog(self, current_version, new_version):
        ...
        # 更新主更新日志文件
        self.update_main_changelog(changelog_content)
