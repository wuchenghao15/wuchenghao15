...
def test_ai_auto_generate():
    ...
    print(str(status_result, ensure_ascii=False, indent=2))
    ...
    print(str(allocate_result, ensure_ascii=False, indent=2))
    ...
    print(str(system_status, ensure_ascii=False, indent=2))
