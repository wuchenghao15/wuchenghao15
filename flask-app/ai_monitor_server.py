...
class AIMonitorServer:
    ...
    def _perform_divergent_thinking(self):
        ...
        logger.info("开始执行发散式思维...")
        
        try:
            # 实现发散式思维逻辑
            logger.info("发散式思维执行完成")
        except Exception as e:
    ...
    def get_status(self):
        ...
        with self.thread_lock:
            return {
                ...
                "monitoring_modules": copy.deepcopy(self.monitoring_modules),
    ...
    def toggle_monitoring_module(self, module_name, enabled):
        """切换监控模块"""
        with self.thread_lock:
