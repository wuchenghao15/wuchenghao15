...
| 选项 | 简写 | 描述 |
|--------|-------|-------------|
| `--provider` | `-p` | 提供商 preset (`openai` / `anthropic` / `google` / `orcarouter` / `deepseek` / `bailian` / `vllm`) |
...
| 选项 | 简写 | 描述 |
|--------|-------|-------------|
| `--provider` | `-p` | 提供商 preset（如 `openai`、`anthropic`、`google`、`orcarouter`、`deepseek`、`bailian`、`vllm`） |
