...
class AutoSyncUpgradeService:
    ...
    def sync_git(self, force: bool = False) -> Dict[str, Any]:
        ...
        with self._lock:
                ...
                if add_result['success']:
                    ...
                    if commit_result['success']:
                        ...
                        if push_result['success']:
                            ...
                            self._record_sync('auto_commit_push', 'failed', push_result['stder'])
                            result['success'] = False
                    else:
                        self._record_sync('auto_commit', 'failed', commit_result['stder'])
                        result['success'] = False
                else:
                    self._record_sync('auto_add', 'failed', add_result['stder'])
                    result['success'] = False
            else:
            ...
            if pull_result['success']:
                ...
                self._record_sync('git_pull', 'failed', pull_result['stder'])
    ...
    def _create_backup(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {'success': False, 'message': result['stder']}
        except Exception as e:
