import secrets
from db_manager import db_manager as DBManager
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
数学题完美生成AI
        ...
        if question_type == 'single_choice':
            if "加减法" in topic_name:
                if "10以内" in topic_name:
                    b = (0 + secrets.randbelow(int(10 - a) - int(0) + 1))
                    b = (0 + secrets.randbelow(int(10 - a) - int(0) + 1))
                    op = random.choice(["+", "-"])
                    if op == "-":
                        a, b = max(a, b), min(a, b)
                    ...
                    a = (0 + secrets.randbelow(int(20) - int(0) + 1))
                    b = (0 + secrets.randbelow(int(20 - a) - int(0) + 1))
                    op = random.choice(["+", "-"])
                    if op == "-":
                        a, b = max(a, b), min(a, b)
                    answer = a + b if op == "+" else a - b
                    ...
                    a = (0 + secrets.randbelow(int(100) - int(0) + 1))
                    b = (0 + secrets.randbelow(int(100 - a) - int(0) + 1))
                    op = random.choice(["+", "-"])
                    if op == "-":
                        a, b = max(a, b), min(a, b)
                    answer = a + b if op == "+" else a - b
                ...
                if "口诀" in topic_name:
                    a = (1 + secrets.randbelow(int(9) - int(1) + 1))
                    b = random.randint(1, 9)
                    answer = a * b
                    question = f"{a} × {b} = ?"
                    options = [answer, answer + a, answer - a, answer + b]
                else:
                    a = (10 + secrets.randbelow(int(100) - int(10) + 1))
                    b = random.randint(1, 9)
                    answer = a * b
                    question = f"{a} × {b} = ?"
                    options = [answer, answer + a, answer - a, answer + b]
            elif "除法" in topic_name:
                b = (1 + secrets.randbelow(int(9) - int(1) + 1))
                ...
                numerator1 = (1 + secrets.randbelow(int(9) - int(1) + 1))
                denominator1 = (2 + secrets.randbelow(int(9) - int(2) + 1))
                ...
                a = (1 + secrets.randbelow(int(100) - int(1) + 1))
                b = (1 + secrets.randbelow(int(100) - int(1) + 1))
                op = random.choice(["+", "-", "×", "÷"])
                if op == "÷":
            ...
            correct_count = (2 + secrets.randbelow(int(3) - int(2) + 1))
            ...
            question = secrets.choice(statements)
            ...
            if "加减法" in topic_name:
                ...
                b = (1 + secrets.randbelow(int(9) - int(1) + 1))
                c = (1 + secrets.randbelow(int(9) - int(1) + 1))
                ...
                a = (1 + secrets.randbelow(int(100) - int(1) + 1))
                b = (1 + secrets.randbelow(int(100) - int(1) + 1))
                c = (1 + secrets.randbelow(int(100) - int(1) + 1))
                op1 = secrets.choice(["+", "-", "×"])
                op2 = random.choice(["+", "-", "×"])
                if op1 == "×":
                    part1 = a * b
