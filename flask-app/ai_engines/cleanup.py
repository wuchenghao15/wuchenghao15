...
class CleanupAI:
    ...
    def cleanup_resources(self):
        ...
        try:
            ...
            self.logger.error(f"{self.instance_id} 清理系统资源失败: {str(e)}")
            return None
    ...
    def optimize_storage(self):
        ...
        try:
            ...
            large_files = self._find_large_files(Config.BASE_DIR)
            ...
            self.logger.error(f"{self.instance_id} 优化存储失败: {str(e)}")
            return None
