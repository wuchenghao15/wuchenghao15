    ...
    def __init__(self):
        ...
        self.new_ai_types = [
            ...
            },
            {
                ...
                'functions': ['专家团队组建', '协作过程管理', '协作成果评估'],
        ...
        try:
            ...
            for ai_type_info in self.new_ai_types:
                ...
                if not cursor.fetchone():
                    ...
                    logger.info(f"AI类型已存在: {ai_type_info['name']}")
...
def main():
    ...
    for config_name, config_value in expert_configs.items():
        category = config_name.split('_')[1]
