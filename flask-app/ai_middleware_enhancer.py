...
class AIMiddlewareEnhancer:
    ...
    def update_app_init(self):
        ...
        # 检查是否已初始化中间件
        if 'from app.middlewares import middleware_manager, init_middlewares' in content and 'init_middlewares()' in content:
        ...
        create_app_end = updated_content.find('    return app')
        if create_app_end != -1:
