...
class AIAndExerciseAnalysisSystemEnhancer:
    ...
    def __init__(self):
        ...
        self.new_ai_types = [
            ...
            {
                'ai_type': 'exam_point_analysis_ai',
                'name': '考点分析AI',
            ...
            {
                'ai_type': 'error_question_analysis_ai',
                'name': '错题分析AI',
            ...
            {
                'ai_type': 'knowledge_connection_explanation_ai',
                'name': '知识联系讲解AI',
        ...
        self.exercise_analysis_system_configs = {
            'general': {
                'enabled': True,
                'exercise_types': ['homework', 'practice', 'quiz', 'exam'],
                'auto_analysis': True,
            ...
            'knowledge_focus': {
                ...
                'extraction_methods': ['tfidf', 'frequency', 'expert_weighting'],
                'highlighting': True,
        ...
        try:
            ...
            for config_category, config_values in self.exercise_analysis_system_configs.items():
                for config_name, config_value in config_values.items():
                    full_config_name = f"exercise_analysis_{config_category}_{config_name}"
...
def main():
    ...
    # 过滤出习题分析系统相关的AI类型
    exercise_ai_types = [ai for ai in ai_types if 'exercise' in ai['ai_type'] or 'exam' in ai['ai_type'] or 'error' in ai['ai_type'] or 'knowledge' in ai['ai_type']]
