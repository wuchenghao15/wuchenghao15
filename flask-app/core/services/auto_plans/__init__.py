...
使用方式:
    ...
    plan = get_plan(r'system_maintenance')
...
__all__ = [
    r'AbstractAutoPlan',
    r'CentralPlanScheduler',
    r'PlanStatus',
    r'PlanResult',
    r'get_plan_scheduler',
    r'get_plan',
    r'list_all_plans',
    r'create_all_plans_and_register',
    # 具体计划
    r'SystemMaintenancePlan',
    r'AIFeedingPlan',
    r'QuestionBankPlan',
    r'TeachingSyncPlan',
    r'AIEmployeeMaintenancePlan',
    r'BackendInspectionPlan',
    r'DBSecurityPlan',
    r'VikeyMonitorPlan',
    r'AIConversationPlan',
    r'PointsResetPlan',
    r'PointsMallPlan',
    r'LunarBuddhistPlan',
    r'AutoExtendPlan',
    r'get_dynamic_generator',
]
