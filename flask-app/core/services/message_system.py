...
class MessageSystem:
    ...
    def start(self, host: str = '127.0.0.1', port: int = 5001):
        """启动消息服务"""
        if not self.socketio:
            logger("[消息系统] SocketIO不可用，请安装 flask-socketio")
            return
