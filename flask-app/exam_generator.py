...
class ExamGenerator:
    ...
    def _load_settings_from_file(self):
        ...
        try:
            ...
            logger.error(f"从配置文件加载设置失败: {str(e)}")
            return None
    ...
    def update_exam_settings(self, new_settings):
        ...
        try:
            ...
            for key, value in new_settings.items():
                SystemSettings.update_or_create(
                    key=key,
                    value=str(value),
    ...
    def get_questions_from_db(self, subject, difficulty=None, question_type=None, count=10, knowledge_points=None, exclude_question_ids=None):
        ...
        try:
            ...
            for question in all_questions:
                question_data = json.loads(question.content)
            ...
            # 优先选择使用次数较少的题目
            filtered_questions.sort(key=lambda x: x.get('usage_count', 0))
            
            # 随机选择题目
            if len(filtered_questions) > count:
                # 使用加权随机选择，优先选择使用次数少的题目
    ...
    def _generate_spelling_distractor(self, correct_word):
        """
        生成拼写相似的干扰项
        ...
        if len(correct_word) <= 3:
            ...
            # 长单词，替换一个字母
            import random
            idx = random.randint(1, len(correct_word) - 2)
            # 生成一个不同的字母
        ...
        try:
            ...
            for progress in all_progress:
                if progress.total_practiced < 10:
                    ...
                    # 计算正确率
                    accuracy = progress.correct_count / progress.total_practiced
                    if accuracy < 0.6:
                        # 正确率低于60%，建议重点练习
                        suggestions.append({
                            "type": "focus_practice",
    ...
    def generate_questions_with_ai(self, subject, difficulty, question_type, count=10):
        ...
        Returns:
            唯一的AI生成题目列表
        """
        logger.info(f"使用AI生成 {count} 道{subject}{difficulty}难度{question_type}题目")
    ...
    def _generate_question_variant(self, base_question):
        """
        生成题目变体
        ...
        if variant['type'] == 'single_choice':
            ...
            if 'options' in variant and variant['options']:
                ...
                variant['answer'] = variant['options'].index(correct_answer)
    ...
    def _generate_english_intermediate_question(self, index):
        ...
        templates = [
            ...
            },
            {
                ...
                "explanation": "The past perfect tense is used to talk about an action that was completed before another action in the past. The structure is: subject + had + past participle.",
            ...
            },
            {
                ...
                "explanation": "The phrasal verb 'put off' means to delay doing something.",
    ...
    def _generate_english_advanced_question(self, index):
        ...
        templates = [
            ...
            },
            {
                ...
                "distractors": ["He runs like a cheetah.", 
                             "She sings beautifully.", 
                             "It's as cold as ice outside."],
            ...
            },
            {
                ...
                "distractors": ["'Affect' is usually a noun meaning the result, while 'effect' is usually a verb meaning to influence.",
                             ...
                             "'Affect' is used for positive changes, while 'effect' is used for negative changes."],
            ...
            },
            {
                ...
                "distractors": ["I would rather to stay home than go to the party.",
                             "I rather stay home than go to the party.",
            ...
            },
            {
                ...
                "correct_answer": "Her smile is like a ray of sunshine.",
        ...
        templates = [
            ...
            },
            {
                ...
                "distractors": ["A large animal in a small space",
                             "A difficult task that requires teamwork",
                             "A hidden problem that no one notices"],
                "explanation": "'The elephant in the room' refers to an obvious and important issue that everyone present is aware of but avoids discussing.",
                "vocabulary": ["idiom", "elephant in the room", "obvious problem", "ignore"]
            },
            {
                "question": "Which sentence uses the pluperfect tense correctly?",
                ...
                "distractors": ["By the time we arrived, they already left.",
                             ...
                             "By the time we arrived, they was already left."],
                "explanation": "The pluperfect tense (past perfect) is used to show that one past action happened before another past action. It is formed with 'had' + past participle.",
                "vocabulary": ["pluperfect tense", "past perfect", "past action", "had", "past participle"]
            },
            {
                "question": "What is the meaning of the term 'zeugma' in literature?",
                "correct_answer": "A figure of speech where a word applies to two others in different ways",
                "distractors": ["A type of rhyme scheme in poetry",
                ...
                "vocabulary": ["zeugma", "figure of speech", "literature", "humorous", "dramatic effect"]
            },
            {
                "question": "What does the phrasal verb 'fall through' mean in this sentence: 'Our plans for the weekend fell through.'",
            ...
            },
            {
                ...
                "vocabulary": ["imply", "infer", "suggest", "deduce", "indirectly"]
            },
            {
            ...
            },
            {
                ...
                "distractors": ["A direct comparison between two unlike things",
        ...
        if difficulty == 'beginner':
            templates = [
                ...
                },
                {
                    ...
                    "explanation": "'毎日'は'every day'を意味し、'行きます'は現在形で'go'を意味します。",
            ...
            templates = [
                {
                    ...
                    "distractors": ["This law is to restrict the rights of citizens.", 
                                 "This law is to explain the rights of citizens.", 
                ...
                },
                {
                    ...
                    "explanation": "'証明されている'は'has been proven'を意味します。",
                ...
                },
                {
                    ...
                    "distractors": ["This policy is promoting economic growth.", 
                                 "This policy promoted economic growth.", 
                                 "This policy will promote economic growth."],
                    "explanation": "'目的としている'は'aims to'または'is intended to'を意味します。",
                    "vocabulary": ["政策", "経済成長", "促進する", "目的としている"]
                }
            ]
    ...
    def _generate_generic_question(self, subject, difficulty, question_type, index):
        ...
        """
        # 通用题目模板
        question = f"What is the {difficulty} level question about {subject} #{index}?"
        
        # 生成具有混淆性的选项
        correct_answer = f"Correct answer for {subject} question #{index}"
        distractors = [
    ...
    def generate_listening_question(self, subject, difficulty, count=5, auto_save=True):
        ...
        for i in range(count):
            ...
            listening_question = {
                ...
                "difficulty_assessment": content_analysis['difficulty_assessment'],
            ...
            if auto_save:
                try:
                    ...
                    knowledge = AIBrainKnowledge(
                        ...
                        content=json.dumps(listening_question, ensure_ascii=False),
    ...
    def _classify_listening_content(self, audio_content, subject):
        ...
        try:
            ...
            if classification_result['success'] and difficulty_result['success']:
                # 解析分类结果
        ...
        try:
            ...
            try:
                ...
                for knowledge in all_listening_questions:
                    question_data = json.loads(knowledge.content)
                ...
                if not current_question:
                    ...
                    for exam_knowledge in all_exams:
                        exam_data = json.loads(exam_knowledge.content)
                ...
                if not current_question:
                    logger.error(f"未找到听力题: {question_id}")
                    return {
                        "success": False,
                ...
                current_question = {
                    ...
                    "subject": "english",
                    "audio_content": {
                        "transcript": "This is a sample listening transcript."
                    },
                    "comprehension_questions": []
                }
            
            # 生成改进建议
            improvement_prompt = f"基于以下用户反馈，改进听力题：\n\n"
            improvement_prompt += f"当前听力题：{json.dumps(current_question, ensure_ascii=False)}\n\n"
            improvement_prompt += f"用户反馈：{json.dumps(feedback, ensure_ascii=False)}\n\n"
            improvement_prompt += "请生成改进后的听力题，包括改进后的听力文本和理解题。确保输出格式清晰，易于解析。"
            
            improvement_result = ai_service_manager.infer('default_text_gen', improvement_prompt, subject=current_question.get('subject', 'english'))
            ...
            if improvement_result['success']:
                ...
                elif feedback['difficulty_feedback'] == 1 and current_level_index < len(difficulty_levels) - 1:
                    # 太简单，提高难度
                    new_difficulty = difficulty_levels[current_level_index + 1]
                else:
                    # 难度适中，保持不变
                ...
                try:
                    ...
                    # 创建或更新知识条目
                    if 'current_knowledge' in locals():
                        # 更新现有条目
                        current_knowledge.content = json.dumps(new_listening_question, ensure_ascii=False)
                        ...
                        new_knowledge = AIBrainKnowledge(
                            knowledge_id=f"knowledge-{uuid.uuid4().hex[:8]}",
                            title=f"听力题: {new_listening_question['audio_content']['title']}",
                            content=json.dumps(new_listening_question, ensure_ascii=False),
                            knowledge_type='listening_question',
                            source='AI生成',
    ...
    def _generate_comprehension_questions(self, audio_content, subject, difficulty, count):
        ...
        try:
            ...
            # 使用AI生成理解题
            ai_prompt = f"基于以下听力文本，为{subject}的{difficulty}难度测试生成{count}个多样化的理解题，包括单项选择、多项选择、填空和简答题等不同题型。每个题目需要有正确答案和解析。\n\n听力文本：{transcript}"
            ai_result = ai_service_manager.infer('default_text_gen', ai_prompt, subject=subject, difficulty=difficulty)
    ...
    def _generate_single_choice_comprehension_question(self, audio_content, subject, difficulty, index):
        ...
        if subject == 'english':
            questions = [
                ...
                f"What is the expected outcome of the project?"
            ]
            options_list = [
                ["A cup of tea", "A coffee", "A glass of water", "A sandwich"],
                ["On the left side of the street", "On the right side of the street", "At the traffic light", "Two blocks away"],
                ...
                ["Holding contradictory beliefs", "Having clear thoughts", "Making rational decisions", "Understanding complex ideas"],
            ...
            questions = [
                ...
                f"認知的不協和とは何ですか？",
                f"話者は英語をどれくらい勉強していますか？",
                f"講義の主なトピックは何ですか？",
                f"誰が新しい種を発見しましたか？",
                f"新しい政策の効果は何ですか？",
                f"話者は何をすることを提案していますか？",
                f"二人の話者の関係は何ですか？",
                f"会議は何時に始まりますか？",
                f"イベントはどこで行われますか？",
                f"話者はなぜ期限を逃しましたか？",
                ...
                f"会議には何人参加しましたか？",
                f"プロジェクトの予想される結果は何ですか？"
            ]
            options_list = [
                ["お茶", "コーヒー", "水", "サンドイッチ"],
                ["通りの左側", "通りの右側", "信号のところ", "2つブロック先"],
                ["サーモンのグリルとご飯", "チキンカレー", "野菜スープ", "ソースつきパスタ"],
                ["新しいマーケティングキャンペーン", "価格の低下", "新製品の発売", "販売網の拡大"],
                ["アマゾンの熱帯雨林", "アフリカのサバンナ", "オーストラリアの砂漠", "アジアのジャングル"],
        ...
        return {
            ...
            "explanation": f"This is the explanation for question {index}.",
            "index": index
        }
    ...
    def _generate_fill_in_blank_comprehension_question(self, audio_content, subject, difficulty, index):
        ...
        if subject == 'english':
            questions = [
                f"Speaker A offered Speaker B a ________.",
            ...
            correct_answers = ["coffee", "right", "salmon", "15"]
        else:  # japanese
            questions = [
                f"話者Aは話者Bに________を勧めました。",
                f"地下鉄の駅は通りの________側にあります。",
                f"お客は________とご飯を注文しました。",
                f"売上高は先季度と比較して________％増加しました。"
            ]
            correct_answers = ["コーヒー", "右", "サーモン", "15"]
    ...
    def _generate_short_answer_comprehension_question(self, audio_content, subject, difficulty, index):
        ...
        if subject == 'english':
            questions = [
                f"What did Speaker A offer to Speaker B?",
                f"How can the customer get to the subway station?",
                f"What was the main reason for the sales increase?",
                f"Where was the new butterfly species discovered?"
            ]
            correct_answers = [
            ...
            correct_answers = [
                "コーヒー",
                "まっすぐに2つブロック行って、信号で左に曲がってください。地下鉄の駅は右側にあります。",
                "新しいマーケティングキャンペーン",
                "アマゾンの熱帯雨林"
            ]
    ...
    def generate_personalized_exam(self, user_preferences, exclude_question_ids=None):
        ...
        user_preferences 格式:
        {
            ...
            "source_distribution": {
                "database": 0.5,  # 数据库题库占比
                "ai_generated": 0.3,  # AI生成占比
                "web_crawled": 0.2  # 网络爬取占比
            },
        ...
        Returns:
            生成的个性化试卷
        """
        logger.info(f"为用户 {user_preferences['user_id']} 生成个性化试卷")
        
        # 如果没有提供排除的题目ID，尝试获取用户已做的题目ID
        if not exclude_question_ids and 'username' in user_preferences:
            exclude_question_ids = self.get_user_answered_question_ids(user_preferences['username'])
            logger.info(f"获取到用户 {user_preferences['username']} 的 {len(exclude_question_ids)} 道已做题目")
        
        total_questions = user_preferences['total_questions']
        source_dist = user_preferences['source_distribution']
        
        # 计算各来源需要的题目数量
        db_count = int(total_questions * source_dist['database'])
        ai_count = int(total_questions * source_dist['ai_generated'])
        web_count = total_questions - db_count - ai_count  # 确保总题数准确
        
        # 从不同来源获取题目
        db_questions = self.get_questions_from_db(
            user_preferences['subject'],
            user_preferences['difficulty'],
            user_preferences['question_type'],
            db_count,
            knowledge_points=user_preferences.get('knowledge_points'),
            exclude_question_ids=exclude_question_ids
        )
        
        ai_questions = self.generate_questions_with_ai(
            user_preferences['subject'],
            user_preferences['difficulty'],
            user_preferences['question_type'],
            ai_count
        ...
        web_questions = self.fetch_questions_from_web(
            user_preferences['subject'],
            user_preferences['difficulty'],
            user_preferences['question_type'],
            web_count
        ...
        # 合并所有题目
        all_questions = db_questions + ai_questions + web_questions
        
        # 再次去重，确保所有题目都是唯一的
        seen_question_ids = set()
        unique_questions = []
        for question in all_questions:
            if 'question_id' in question and question['question_id'] not in seen_question_ids:
                seen_question_ids.add(question['question_id'])
                unique_questions.append(question)
            elif 'question_id' not in question:  # 没有question_id的题目直接添加
                unique_questions.append(question)
        
        # 如果去重后题目数量不足，生成额外的AI题目
        if len(unique_questions) < total_questions:
            additional_count = total_questions - len(unique_questions)
            logger.info(f"去重后题目数量不足，生成额外 {additional_count} 道AI题目")
            additional_ai_questions = self.generate_questions_with_ai(
                user_preferences['subject'],
                user_preferences['difficulty'],
                user_preferences['question_type'],
                additional_count
            )
            unique_questions.extend(additional_ai_questions)
        ...
        # 提取题目ID列表，方便后续保存用户答题记录
        question_ids = [q.get('question_id', f"unknown_{i}") for i, q in enumerate(unique_questions)]
        ...
        exam = {
            ...
            "question_type": user_preferences['question_type'],
            ...
            "source_statistics": {
                "database": len(db_questions),
                "ai_generated": len(ai_questions),
                "web_crawled": len(web_questions)
            }
        }
        
        logger.info(f"成功生成试卷 {exam['exam_id']}，包含 {len(unique_questions)} 道唯一题目")
        return exam
    ...
    def save_exam_to_db(self, exam):
        ...
        try:
            ...
            exam_knowledge = AIBrainKnowledge(
                ...
                content=json.dumps(exam, ensure_ascii=False),
            ...
            activity = AIBrainActivity(
                ...
                description=f"生成个性化试卷: {exam['title']}",
                source='AI生成',
                source_id=exam['exam_id'],
                metadata={
            ...
            logger.info(f"试卷 {exam['exam_id']} 成功保存到数据库")
            return True
        except Exception as e:
    ...
    def export_exam_as_json(self, exam, file_path=None):
        ...
        """
        if not file_path:
            file_path = f"exam_{exam['exam_id']}_{datetime.now().strftime('%Y%m%d%H%M%S')}.json"
        
        try:
            with open(file_path, 'w', encoding='utf-8') as f:
                json.dump(exam, f, ensure_ascii=False, indent=2)
            
            logger.info(f"试卷 {exam['exam_id']} 成功导出为JSON文件: {file_path}")
            return file_path
        except Exception as e:
    ...
    def get_user_level(self, username, subject):
        ...
        Returns:
            用户等级（beginner, intermediate, advanced, expert）
        """
        logger.info(f"获取用户 {username} 的 {subject} 等级")
        
        try:
            # 根据实际数据库结构实现获取用户等级的逻辑
            # 这里假设存在用户等级表
    ...
    def generate_practice_exam(self, user_preferences):
        ...
        exam['target_difficulty'] = target_difficulty
        exam['knowledge_points'] = user_preferences.get('knowledge_points', [])
    ...
    def generate_graded_exam(self, user_preferences):
        ...
        """
        logger.info(f"为用户 {user_preferences['username']} 生成分级试卷")
        ...
        if user_level == 'beginner':
            # 初级用户：80%初级，20%中级
            difficulty_counts = {'beginner': int(total_questions * 0.8), 'intermediate': total_questions - int(total_questions * 0.8)}
        ...
        logger.info(f"分级试卷难度分布: {difficulty_counts}")
    ...
    def save_practice_record(self, username, exam_id, score, answers, question_ids):
        """
        保存用户练习记录
        ...
        try:
            ...
            logger.info(f"成功保存用户 {username} 的练习记录，试卷ID: {exam_id}，得分: {score}，题目数量: {len(question_ids)}")
            return True
        except Exception as e:
            logger.error(f"保存用户 {username} 练习记录失败: {str(e)}")
            return False
    ...
    def get_user_answered_questions(self, username, subject=None, limit=100):
        ...
        try:
            ...
            for record in answered_questions:
                ...
                try:
                    # 根据题目ID获取题目
                    all_questions = AIBrainKnowledge.get_all()
    ...
    def generate_and_save_graded_exam(self, user_preferences):
        ...
        """
        # 生成分级试卷
        exam = self.generate_graded_exam(user_preferences)
    ...
    def get_user_exams(self, user_id, exam_type=None):
        ...
        Returns:
            试卷列表
        """
        logger.info(f"获取用户 {user_id} 的试卷，类型: {exam_type}")
        ...
        try:
            ...
            for exam in all_exams:
                exam_data = json.loads(exam.content)
        ...
        try:
            ...
            for exam in all_exams:
                ...
                if exam_data.get('exam_id') == exam_id:
                    ...
                    # 保存更新后的试卷
                    exam.content = json.dumps(exam_data, ensure_ascii=False)
                    exam.save()
        ...
        try:
            ...
            for day in range(1, days + 1):
                ...
                daily_plan["tasks"].append({
                    "type": "basic_practice",
                    "content": f"完成 {subject} 基础练习 {10 + day} 道",
                    "duration": 30,  # 分钟
                    "priority": "high"
                })
                ...
                # 2. 根据建议生成针对性练习
                if suggestions:
                    for suggestion in suggestions[:2]:  # 每天最多2个针对性练习
...
if __name__ == '__main__':
    ...
    print(f"生成时间: {exam['generated_at']}")
