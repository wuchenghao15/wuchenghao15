...
class MonitoringIntegrator:
    ...
    def register_ai_employee_system(self):
        ...
        self.integrated_systems.append("ai_employee_system")
    ...
    def register_distributed_system(self):
        ...
        self.integrated_systems.append("distributed_system")
    ...
    def register_shadow_system(self):
        ...
        self.integrated_systems.append("shadow_system")
        logger.info("影子系统已注册")
    ...
    def register_ai_brain_system(self):
        ...
        self.integrated_systems.append("ai_brain_system")
    ...
    def display_dashboard(self):
        ...
        for metric_key, metric in dashboard["latest_metrics"].items():
            if "cpu_usage" in metric_key or "memory_usage" in metric_key:
