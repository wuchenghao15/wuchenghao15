...
class SystemKnowledgeExpander:
    ...
    def expand_system_config(self):
        ...
        try:
            ...
            new_configs = [
                ...
                {
                    "config_key": "TEST_SYSTEM_TEST_INTERVAL",
                    "config_value": "3600",
                    "config_type": "int",
    ...
    def create_system_function_instances(self):
        ...
        try:
            ...
            system_instances = [
                ...
                {
                    "ai_name": "security_manager",
                    "ai_type": "security",
                    "description": "安全管理AI"
                },
                {
                    "ai_name": "log_analyzer",
                    "ai_type": "analyzer",
                    "description": "日志分析AI"
                },
                {
                    "ai_name": "config_manager",
                    "ai_type": "manager",
                    "description": "配置管理AI"
                },
                {
                    "ai_name": "knowledge_expander",
                    "ai_type": "expander",
                    "description": "知识扩充AI"
                }
            ]
            ...
            self.conn.commit()
            print(f"成功创建 {added_count} 个系统功能AI实例")
            return added_count
        except Exception as e:
    ...
    def expand_question_bank_with_system_knowledge(self, target_count=50):
        """扩充题库，添加系统功能相关题目"""
        """
        扩充题库，添加系统功能相关的题目
        ...
        try:
            # 获取日语知识库ID
            self.cursor.execute("SELECT id FROM question_languages WHERE language_code = 'japanese'")
            ...
            system_questions = [
                ...
                },
                {
                    ...
                    "correct_answer": "D",
                    "explanation": "安全管理AI具有监控系统安全状况、处理系统安全事件和生成安全报告等功能。"
                },
                {
                    "content": "系统日志分析AI的主要职责是什么？",
                    "options": [
                        "A. 收集系统日志",
                        "B. 分析系统日志",
                        "C. 生成日志报告",
    ...
    def get_system_knowledge_stats(self):
        ...
        try:
            ...
            stats["system_config_count"] = self.cursor.fetchone()[0]
            
            # 获取AI集合数量
            self.cursor.execute("SELECT COUNT(*) FROM ai_collections")
            stats["ai_collection_count"] = self.cursor.fetchone()[0]
            ...
            """)
            stats["system_function_question_count"] = self.cursor.fetchone()[0]
