...
'''
    ...
    def report_to_database(self):
        ...
        try:
            ...
            # 插入环境信息
            env_info = {
                'environment_id': f"system-env-{int(time.time())}",
                'system_type': self.system_type,
                'system_version': self.system_version,
                'python_version': self.python_version,
                'resource_status': json.dumps(self.get_system_resources()),
            ...
            error_cases = [
                {
                    "id": "env-case-001",
                    "title": "系统内存不足",
                    "description": "系统内存使用率过高，导致应用程序运行缓慢",
