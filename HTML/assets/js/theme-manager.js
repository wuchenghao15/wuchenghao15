...
class ThemeManager {
    ...
    switchTheme(themeName, force = false) {
        ...
        // 移除所有主题类
        document.body.classList.remove('light-theme', 'dark-theme', 'sunset-theme', 'teal-theme', 'memorial-theme', 'celebration-theme');
    ...
    setupEventListeners() {
        ...
        // 初始化主题切换按钮
        const themeButton = document.querySelector('.theme-toggle .theme-btn, .header-content .theme-btn, #theme-toggle');
...
// 暴露switchTheme函数到全局作用域，用于HTML按钮调用
