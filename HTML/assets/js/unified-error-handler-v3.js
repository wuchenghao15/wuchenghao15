...
class MTSCOSUnifiedErrorHandler {
    ...
    saveErrorLog() {
        try {
            ...
            localStorage.setItem('mtscos_warning_log', JSON.stringify(this.warningLog));
    ...
    loadErrorLog() {
        try {
            ...
            const savedWarningLog = localStorage.getItem('mtscos_warning_log');
            ...
            if (savedWarningLog) {
                this.warningLog = JSON.parse(savedWarningLog);
            }
    ...
    logWarning(message, data = {}) {
        ...
        const warning = {
            ...
            url: window.location.href,
            userAgent: navigator.userAgent,
            type: this.errorTypes.PERFORMANCE_WARNING,
            message,
            severity: 'warning',
            ...data
        };
    ...
    clearLogs() {
        ...
        localStorage.removeItem('mtscos_warning_log');
