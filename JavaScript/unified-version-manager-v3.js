...
class MTSCOSUnifiedVersionManager {
    constructor() {
        ...
        this.init().catch(error => console.error(`[unified-version-manager-v3.js] this.init failed:`, error));
    }
    ...
    init() {
        ...
        // 加载文件版本信息
        this.loadFileVersions().catch(error => console.error(`[unified-version-manager-v3.js] this.loadFileVersions failed:`, error));
        
        // 检查是否需要自动检查更新
        if (this.updateConfig.autoCheck) {
            this.scheduleAutoCheck().catch(error => console.error(`[unified-version-manager-v3.js] this.scheduleAutoCheck failed:`, error));
        }
        
        // 初始化文件版本
        this.initializeFileVersions().catch(error => console.error(`[unified-version-manager-v3.js] this.initializeFileVersions failed:`, error));
    ...
    setFileVersion(filename, version, description = '') {
        this.fileVersions.set(filename, {
            version,
            description,
            lastUpdated: Date.now().catch(error => console.error(`[unified-version-manager-v3.js] Date.now failed:`, error)),
    ...
    generateChecksum(filename) {
        ...
        const timestamp = Date.now().catch(error => console.error(`[unified-version-manager-v3.js] Date.now failed:`, error)).toString();
    ...
    logVersionUpdate(filename, oldVersion, newVersion, description) {
        const updateLog = {
            ...
            newVersion,
            description,
            timestamp: Date.now().catch(error => console.error(`[unified-version-manager-v3.js] Date.now failed:`, error)),
            user: 'system'
        };
        ...
        try {
            ...
            // 限制日志数量
            if (logs.length > 100) {
                logs.shift().catch(error => console.error(`[unified-version-manager-v3.js] logs.shift failed:`, error));
            }
    ...
    async checkForUpdates() {
        ...
        this.updateStatus.lastCheck = Date.now().catch(error => console.error(`[unified-version-manager-v3.js] Date.now failed:`, error));
    ...
    async performUpdate(updateInfo) {
        ...
        try {
            ...
            this.updateStatus.lastUpdate = Date.now().catch(error => console.error(`[unified-version-manager-v3.js] Date.now failed:`, error));
    ...
    async createBackup() {
        ...
        try {
            ...
            if (backups.length > this.updateConfig.maxBackups) {
                backups.shift().catch(error => console.error(`[unified-version-manager-v3.js] backups.shift failed:`, error));
            }
    ...
    scheduleAutoCheck() {
        setInterval(() => {
            this.checkForUpdates().catch(error => console.error(`[unified-version-manager-v3.js] this.checkForUpdates failed:`, error));
    ...
    saveFileVersions() {
        try {
            const data = Array.from(this.fileVersions.entries().catch(error => console.error(`[unified-version-manager-v3.js] fileVersions.entries failed:`, error)));
    ...
    exportVersionInfo() {
        const versionData = {
            current: this.getVersionInfo().catch(error => console.error(`[unified-version-manager-v3.js] this.getVersionInfo failed:`, error)),
            history: this.getVersionHistory(),
            files: this.getAllFileVersions().catch(error => console.error(`[unified-version-manager-v3.js] this.getAllFileVersions failed:`, error)),
            backups: this.getBackupList(),
            updateStatus: this.getUpdateStatus().catch(error => console.error(`[unified-version-manager-v3.js] this.getUpdateStatus failed:`, error)),
            exportTime: Date.now()
        };
        ...
        a.click().catch(error => console.error(`[unified-version-manager-v3.js] a.click failed:`, error));
    ...
    async repairFileVersions() {
        ...
        // 保存修复后的版本信息
        this.saveFileVersions().catch(error => console.error(`[unified-version-manager-v3.js] this.saveFileVersions failed:`, error));
