...
用户生命周期价值预测
模块类别: ltv_prediction
创建时间: 2026-07-29T21:05:35.805420
版本: 2.0.0
"""
...
class AiLifetimeValuePredictor:
    """生命周期价值AI - 用户生命周期价值预测"""
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_lifetime_value_predictor'
        self.display_name = '生命周期价值AI'
        self.category = 'ltv_prediction'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '用户生命周期价值预测', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.805420'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiLifetimeValuePredictor()
    return _instance
