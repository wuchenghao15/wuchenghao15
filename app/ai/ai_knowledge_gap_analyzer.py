...
知识缺口分析，学习建议
模块类别: knowledge_gap
创建时间: 2026-07-29T21:05:36.086528
版本: 2.0.0
"""
...
class AiKnowledgeGapAnalyzer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_knowledge_gap_analyzer'
        self.display_name = '知识缺口AI'
        self.category = 'knowledge_gap'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '知识缺口分析，学习建议', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.086528'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiKnowledgeGapAnalyzer()
    return _instance
