...
洞察提取AI v2
从数据中提取深层洞察，趋势预测
模块类别: insight_extraction
创建时间: 2026-07-29T21:05:35.719499
版本: 2.0.0
"""
...
class AiInsightExtractorV2:
    """洞察提取AI v2 - 从数据中提取深层洞察，趋势预测"""
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_insight_extractor_v2'
        self.display_name = '洞察提取AI v2'
        self.category = 'insight_extraction'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '从数据中提取深层洞察，趋势预测', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.719499'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiInsightExtractorV2()
    return _instance
