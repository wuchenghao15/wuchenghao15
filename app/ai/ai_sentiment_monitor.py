...
舆情监控AI
品牌舆情监控，危机预警
模块类别: sentiment_monitoring
创建时间: 2026-07-29T21:05:35.845859
版本: 2.0.0
"""
...
class AiSentimentMonitor:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_sentiment_monitor'
        self.display_name = '舆情监控AI'
        self.category = 'sentiment_monitoring'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '品牌舆情监控，危机预警', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.845859'}
