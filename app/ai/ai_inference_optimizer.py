...
推理优化AI
推理加速，TensorRT优化
模块类别: inference_optimization
创建时间: 2026-07-29T21:05:36.201267
版本: 2.0.0
"""
...
class AiInferenceOptimizer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_inference_optimizer'
        self.display_name = '推理优化AI'
        self.category = 'inference_optimization'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '推理加速，TensorRT优化', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.201267'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiInferenceOptimizer()
    return _instance
