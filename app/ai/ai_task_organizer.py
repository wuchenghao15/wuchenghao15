...
任务组织AI
任务自动分类，优先级排序
模块类别: task_organization
创建时间: 2026-07-29T21:05:35.958718
版本: 2.0.0
"""
...
class AiTaskOrganizer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_task_organizer'
        self.display_name = '任务组织AI'
        self.category = 'task_organization'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '任务自动分类，优先级排序', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.958718'}
