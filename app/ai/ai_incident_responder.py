...
事件响应AI
安全事件响应，自动处置建议
模块类别: incident_response
创建时间: 2026-07-29T21:05:35.763730
版本: 2.0.0
"""
...
class AiIncidentResponder:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_incident_responder'
        self.display_name = '事件响应AI'
        self.category = 'incident_response'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '安全事件响应，自动处置建议', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.763730'}
