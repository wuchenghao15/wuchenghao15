...
文本摘要，关键点提取
模块类别: summarization
创建时间: 2026-07-29T21:05:35.835222
版本: 2.0.0
"""
...
class AiSummaryEngine:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_summary_engine'
        self.display_name = '摘要引擎AI'
        self.category = 'summarization'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '文本摘要，关键点提取', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.835222'}
