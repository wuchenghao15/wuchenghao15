...
法律案例检索，判例分析
模块类别: legal_research
创建时间: 2026-07-29T21:05:36.029227
版本: 2.0.0
"""
...
class AiLegalResearcher:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_legal_researcher'
        self.display_name = '法律研究AI'
        self.category = 'legal_research'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '法律案例检索，判例分析', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.029227'}
