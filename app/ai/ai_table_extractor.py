...
表格提取AI
表格识别，数据提取
模块类别: table_extraction
创建时间: 2026-07-29T21:05:35.925233
版本: 2.0.0
"""
...
class AiTableExtractor:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_table_extractor'
        self.display_name = '表格提取AI'
        self.category = 'table_extraction'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '表格识别，数据提取', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.925233'}
