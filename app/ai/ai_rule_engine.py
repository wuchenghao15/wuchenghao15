...
业务规则管理，冲突检测
模块类别: rule_engine
创建时间: 2026-07-29T21:05:35.895958
版本: 2.0.0
"""
...
class AiRuleEngine:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_rule_engine'
        self.display_name = '规则引擎AI'
        self.category = 'rule_engine'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '业务规则管理，冲突检测', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.895958'}
