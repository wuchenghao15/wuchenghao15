...
创建时间: 2026-07-29T21:00:12.470547
版本: 1.0.0
"""
...
class AiKnowledgeCurator:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_knowledge_curator'
        self.display_name = '知识策展AI'
    ...
    def get_info(self):
        ...
        return {
            ...
            'display_name': self.display_name,
            'category': self.category,
            'description': '策展和管理知识脑库内容',
            'version': self.version,
            'status': self.status,
            'created_at': '2026-07-29T21:00:12.470547'
        }
