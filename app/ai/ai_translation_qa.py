...
翻译质量AI
翻译质量评估，术语一致性
模块类别: translation_quality
创建时间: 2026-07-29T21:05:35.938497
版本: 2.0.0
"""
...
class AiTranslationQa:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_translation_qa'
        self.display_name = '翻译质量AI'
        self.category = 'translation_quality'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '翻译质量评估，术语一致性', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.938497'}
