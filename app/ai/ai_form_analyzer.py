...
表单识别，字段提取
模块类别: form_analysis
创建时间: 2026-07-29T21:05:35.928597
版本: 2.0.0
"""
...
class AiFormAnalyzer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_form_analyzer'
        self.display_name = '表单分析AI'
        self.category = 'form_analysis'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '表单识别，字段提取', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.928597'}
