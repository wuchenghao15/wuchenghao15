...
日志情报AI
日志聚类，根因分析
模块类别: log_intelligence
创建时间: 2026-07-29T21:05:36.036112
版本: 2.0.0
"""
...
class AiLogIntelligence:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_log_intelligence'
        self.display_name = '日志情报AI'
        self.category = 'log_intelligence'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '日志聚类，根因分析', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.036112'}
