...
新手引导，学习路径推荐
模块类别: onboarding
创建时间: 2026-07-29T21:05:36.052615
版本: 2.0.0
"""
...
class AiOnboardingAssistant:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_onboarding_assistant'
        self.display_name = '入职助手AI'
        self.category = 'onboarding'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '新手引导，学习路径推荐', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.052615'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiOnboardingAssistant()
    return _instance
