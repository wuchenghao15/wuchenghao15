...
智能用户分群，精准营销支持
模块类别: segmentation
创建时间: 2026-07-29T21:05:35.809122
版本: 2.0.0
"""
...
class AiSegmentationEngine:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_segmentation_engine'
        self.display_name = '用户分群AI'
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '智能用户分群，精准营销支持', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.809122'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiSegmentationEngine()
    return _instance
