...
假设分析AI
假设场景分析，敏感性测试
模块类别: what_if_analysis
创建时间: 2026-07-29T21:05:36.153074
版本: 2.0.0
"""
...
class AiWhatIfAnalyzer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_what_if_analyzer'
        self.display_name = '假设分析AI'
        self.category = 'what_if_analysis'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '假设场景分析，敏感性测试', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.153074'}
