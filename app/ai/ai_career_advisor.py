...
职业顾问AI
职业路径建议，能力发展规划
模块类别: career_advisory
创建时间: 2026-07-29T21:05:36.079359
版本: 2.0.0
"""
...
class AiCareerAdvisor:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_career_advisor'
        self.display_name = '职业顾问AI'
        self.category = 'career_advisory'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '职业路径建议，能力发展规划', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.079359'}
