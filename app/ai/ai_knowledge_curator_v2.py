...
知识策展AI v2
策展和管理知识脑库内容，智能分类
模块类别: knowledge_curation
创建时间: 2026-07-29T21:05:35.678088
版本: 2.0.0
"""
...
class AiKnowledgeCuratorV2:
    """知识策展AI v2 - 策展和管理知识脑库内容，智能分类"""
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_knowledge_curator_v2'
        self.display_name = '知识策展AI v2'
        self.category = 'knowledge_curation'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '策展和管理知识脑库内容，智能分类', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.678088'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiKnowledgeCuratorV2()
    return _instance
