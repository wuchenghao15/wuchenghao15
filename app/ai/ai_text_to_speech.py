...
自然语音合成，多音色支持
模块类别: text_to_speech
创建时间: 2026-07-29T21:05:35.934960
版本: 2.0.0
"""
...
class AiTextToSpeech:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_text_to_speech'
        self.display_name = '文字转语音AI'
        self.category = 'text_to_speech'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '自然语音合成，多音色支持', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.934960'}
