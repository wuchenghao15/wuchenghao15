...
文件系统管理AI
文件存储优化，清理建议
模块类别: file_management
创建时间: 2026-07-29T21:05:35.748649
版本: 2.0.0
"""
...
class AiFileSystemManager:
    """文件系统管理AI - 文件存储优化，清理建议"""
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_file_system_manager'
        self.display_name = '文件系统管理AI'
        self.category = 'file_management'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '文件存储优化，清理建议', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.748649'}
