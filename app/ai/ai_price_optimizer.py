...
定价优化AI
动态定价策略，弹性分析
模块类别: pricing_optimization
创建时间: 2026-07-29T21:05:35.821322
版本: 2.0.0
"""
...
class AiPriceOptimizer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_price_optimizer'
        self.display_name = '定价优化AI'
        self.category = 'pricing_optimization'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '动态定价策略，弹性分析', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.821322'}
