...
归因引擎AI
全链路归因，营销效果评估
模块类别: attribution_engine
创建时间: 2026-07-29T21:05:36.107729
版本: 2.0.0
"""
...
class AiAttributionEngine:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_attribution_engine'
        self.display_name = '归因引擎AI'
        self.category = 'attribution_engine'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '全链路归因，营销效果评估', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.107729'}
