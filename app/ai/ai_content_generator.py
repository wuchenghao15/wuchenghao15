...
内容生成AI
多格式内容生成，SEO优化
模块类别: content_generation
创建时间: 2026-07-29T21:05:35.831856
版本: 2.0.0
"""
...
class AiContentGenerator:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_content_generator'
        self.display_name = '内容生成AI'
        self.category = 'content_generation'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '多格式内容生成，SEO优化', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.831856'}
