...
风险评估AI
风险量化，对冲策略
模块类别: risk_assessment
创建时间: 2026-07-29T21:05:36.018880
版本: 2.0.0
"""
...
class AiRiskAssessor:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_risk_assessor'
        self.display_name = '风险评估AI'
        self.category = 'risk_assessment'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '风险量化，对冲策略', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.018880'}
