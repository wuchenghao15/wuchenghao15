...
"""
智能调度AI v2
智能调度AI员工任务优先级，支持负载均衡
模块类别: smart_scheduling
创建时间: 2026-07-29T21:05:35.659326
版本: 2.0.0
"""
...
class AiSmartSchedulerV2:
    """智能调度AI v2 - 智能调度AI员工任务优先级，支持负载均衡"""
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_smart_scheduler_v2'
        self.display_name = '智能调度AI v2'
        self.category = 'smart_scheduling'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '智能调度AI员工任务优先级，支持负载均衡', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.659326'}
