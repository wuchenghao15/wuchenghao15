...
工作流设计AI
工作流自动设计，BPMN支持
模块类别: workflow_design
创建时间: 2026-07-29T21:05:35.887757
版本: 2.0.0
"""
...
class AiWorkflowDesigner:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_workflow_designer'
        self.display_name = '工作流设计AI'
        self.category = 'workflow_design'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '工作流自动设计，BPMN支持', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.887757'}
