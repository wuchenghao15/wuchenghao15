...
缓存管理AI
智能缓存策略管理，命中率优化
模块类别: cache_management
创建时间: 2026-07-29T21:05:35.729985
版本: 2.0.0
"""
...
class AiCacheManager:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_cache_manager'
        self.display_name = '缓存管理AI'
        self.category = 'cache_management'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '智能缓存策略管理，命中率优化', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.729985'}
