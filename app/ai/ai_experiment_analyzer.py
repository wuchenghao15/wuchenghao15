...
实验分析AI
A/B实验分析，统计显著性检验
模块类别: experiment_analysis
创建时间: 2026-07-29T21:05:35.797825
版本: 2.0.0
"""
...
class AiExperimentAnalyzer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_experiment_analyzer'
        self.display_name = '实验分析AI'
        self.category = 'experiment_analysis'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': 'A/B实验分析，统计显著性检验', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.797825'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiExperimentAnalyzer()
    return _instance
