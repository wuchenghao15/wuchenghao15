...
内容策展AI
内容精选，知识图谱构建
模块类别: content_curator
创建时间: 2026-07-29T21:05:36.089984
版本: 2.0.0
"""
...
class AiContentCurator:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_content_curator'
        self.display_name = '内容策展AI'
        self.category = 'content_curator'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '内容精选，知识图谱构建', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.089984'}
