...
创建时间: 2026-07-29T21:00:12.508133
版本: 1.0.0
"""
...
class AiInsightExtractor:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_insight_extractor'
        self.display_name = '洞察提取AI'
    ...
    def get_info(self):
        ...
        return {
            ...
            'display_name': self.display_name,
            'category': self.category,
            'description': '从数据中提取深层洞察',
            'version': self.version,
            'status': self.status,
            'created_at': '2026-07-29T21:00:12.508133'
        }
