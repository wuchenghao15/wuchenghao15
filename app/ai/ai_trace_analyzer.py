...
分布式追踪分析，瓶颈定位
模块类别: trace_analysis
创建时间: 2026-07-29T21:05:36.043984
版本: 2.0.0
"""
...
class AiTraceAnalyzer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_trace_analyzer'
        self.display_name = '链路分析AI'
        self.category = 'trace_analysis'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '分布式追踪分析，瓶颈定位', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.043984'}
