...
特性开关AI
特性开关管理，A/B测试优化
模块类别: feature_management
创建时间: 2026-07-29T21:05:35.793746
版本: 2.0.0
"""
...
class AiFeatureFlagManager:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_feature_flag_manager'
        self.display_name = '特性开关AI'
        self.category = 'feature_management'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '特性开关管理，A/B测试优化', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.793746'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiFeatureFlagManager()
    return _instance
