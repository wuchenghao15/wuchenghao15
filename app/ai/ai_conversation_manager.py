...
创建时间: 2026-07-29T21:00:12.497979
版本: 1.0.0
"""
...
class AiConversationManager:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_conversation_manager'
        self.display_name = '对话管理AI'
    ...
    def get_info(self):
        ...
        return {
            ...
            'display_name': self.display_name,
            'category': self.category,
            'description': '管理多轮对话上下文和流程',
            'version': self.version,
            'status': self.status,
            'created_at': '2026-07-29T21:00:12.497979'
        }
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiConversationManager()
    return _instance
