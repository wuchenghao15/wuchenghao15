...
边缘部署AI
边缘设备部署，模型适配
模块类别: edge_deployment
创建时间: 2026-07-29T21:05:36.205742
版本: 2.0.0
"""
...
class AiEdgeDeployer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_edge_deployer'
        self.display_name = '边缘部署AI'
        self.category = 'edge_deployment'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '边缘设备部署，模型适配', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.205742'}
