...
视频内容分析，关键帧提取
模块类别: video_analysis
创建时间: 2026-07-29T21:05:35.917722
版本: 2.0.0
"""
...
class AiVideoAnalyzer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_video_analyzer'
        self.display_name = '视频分析AI'
        self.category = 'video_analysis'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '视频内容分析，关键帧提取', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.917722'}
