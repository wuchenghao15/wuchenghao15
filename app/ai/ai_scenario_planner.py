...
场景规划AI
多场景规划，应急预案
模块类别: scenario_planning
创建时间: 2026-07-29T21:05:36.156705
版本: 2.0.0
"""
...
class AiScenarioPlanner:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_scenario_planner'
        self.display_name = '场景规划AI'
        self.category = 'scenario_planning'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '多场景规划，应急预案', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.156705'}
