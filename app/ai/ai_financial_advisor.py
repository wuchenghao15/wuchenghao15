...
财务顾问AI
财务分析，投资建议
模块类别: financial_advisory
创建时间: 2026-07-29T21:05:36.015664
版本: 2.0.0
"""
...
class AiFinancialAdvisor:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_financial_advisor'
        self.display_name = '财务顾问AI'
        self.category = 'financial_advisory'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '财务分析，投资建议', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.015664'}
