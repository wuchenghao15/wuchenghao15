...
客服代理AI
智能客服，工单自动处理
模块类别: customer_service
创建时间: 2026-07-29T21:05:35.841964
版本: 2.0.0
"""
...
class AiCustomerServiceAgent:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_customer_service_agent'
        self.display_name = '客服代理AI'
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '智能客服，工单自动处理', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.841964'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiCustomerServiceAgent()
    return _instance
