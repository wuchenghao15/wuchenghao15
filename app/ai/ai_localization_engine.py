...
软件本地化，文化适配
模块类别: localization
创建时间: 2026-07-29T21:05:35.943113
版本: 2.0.0
"""
...
class AiLocalizationEngine:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_localization_engine'
        self.display_name = '本地化引擎AI'
        self.category = 'localization'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '软件本地化，文化适配', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.943113'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiLocalizationEngine()
    return _instance
