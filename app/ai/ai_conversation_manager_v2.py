...
对话管理AI v2
管理多轮对话上下文和流程，意图识别
模块类别: conversation_management
创建时间: 2026-07-29T21:05:35.705978
版本: 2.0.0
"""
...
class AiConversationManagerV2:
    """对话管理AI v2 - 管理多轮对话上下文和流程，意图识别"""
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_conversation_manager_v2'
        self.display_name = '对话管理AI v2'
        self.category = 'conversation_management'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '管理多轮对话上下文和流程，意图识别', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.705978'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiConversationManagerV2()
    return _instance
