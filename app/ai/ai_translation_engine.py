...
多语言翻译，本地化支持
模块类别: translation
创建时间: 2026-07-29T21:05:35.838677
版本: 2.0.0
"""
...
class AiTranslationEngine:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_translation_engine'
        self.display_name = '翻译引擎AI'
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '多语言翻译，本地化支持', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.838677'}
