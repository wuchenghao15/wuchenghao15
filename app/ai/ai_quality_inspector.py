...
创建时间: 2026-07-29T21:00:12.455627
版本: 1.0.0
"""
...
class AiQualityInspector:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_quality_inspector'
        self.display_name = '质量检查AI'
    ...
    def get_info(self):
        ...
        return {
            ...
            'display_name': self.display_name,
            'category': self.category,
            'description': '检查系统输出质量，确保高标准',
            'version': self.version,
            'status': self.status,
            'created_at': '2026-07-29T21:00:12.455627'
        }
