...
决策引擎AI
决策树管理，实时决策支持
模块类别: decision_engine
创建时间: 2026-07-29T21:05:35.899533
版本: 2.0.0
"""
...
class AiDecisionEngine:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_decision_engine'
        self.display_name = '决策引擎AI'
        self.category = 'decision_engine'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '决策树管理，实时决策支持', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.899533'}
