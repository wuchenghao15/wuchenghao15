...
线性规划，整数规划，启发式算法
模块类别: optimization
创建时间: 2026-07-29T21:05:36.171493
版本: 2.0.0
"""
...
class AiOptimizationSolver:
    """优化求解AI - 线性规划，整数规划，启发式算法"""
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_optimization_solver'
        self.display_name = '优化求解AI'
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '线性规划，整数规划，启发式算法', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.171493'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiOptimizationSolver()
    return _instance
