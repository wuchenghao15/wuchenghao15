...
专业翻译AI
专业领域翻译，术语管理
模块类别: professional_translation
创建时间: 2026-07-29T21:05:35.985613
版本: 2.0.0
"""
...
class AiTranslatorPro:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_translator_pro'
        self.display_name = '专业翻译AI'
        self.category = 'professional_translation'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '专业领域翻译，术语管理', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.985613'}
