...
分群引擎专业版
精细分群，标签体系
模块类别: segmentation_pro
创建时间: 2026-07-29T21:05:36.104359
版本: 2.0.0
"""
...
class AiSegmentationPro:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_segmentation_pro'
        self.display_name = '分群引擎专业版'
        self.category = 'segmentation_pro'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '精细分群，标签体系', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.104359'}
