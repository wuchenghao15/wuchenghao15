...
多轮对话管理，意图识别
模块类别: chatbot
创建时间: 2026-07-29T21:05:35.903123
版本: 2.0.0
"""
...
class AiChatbotEngine:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_chatbot_engine'
        self.display_name = '聊天机器人AI'
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '多轮对话管理，意图识别', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.903123'}
