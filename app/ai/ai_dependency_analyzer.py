...
依赖分析AI
依赖关系分析，版本冲突检测
模块类别: dependency_analysis
创建时间: 2026-07-29T21:05:35.756351
版本: 2.0.0
"""
...
class AiDependencyAnalyzer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_dependency_analyzer'
        self.display_name = '依赖分析AI'
        self.category = 'dependency_analysis'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '依赖关系分析，版本冲突检测', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.756351'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiDependencyAnalyzer()
    return _instance
