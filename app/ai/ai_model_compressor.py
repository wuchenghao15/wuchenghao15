...
模型压缩AI
模型量化，剪枝，蒸馏
模块类别: model_compression
创建时间: 2026-07-29T21:05:36.196499
版本: 2.0.0
"""
...
class AiModelCompressor:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_model_compressor'
        self.display_name = '模型压缩AI'
        self.category = 'model_compression'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '模型量化，剪枝，蒸馏', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.196499'}
