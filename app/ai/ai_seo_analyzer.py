...
SEO健康检查，关键词建议
模块类别: seo_analysis
创建时间: 2026-07-29T21:05:35.999269
版本: 2.0.0
"""
...
class AiSeoAnalyzer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_seo_analyzer'
        self.display_name = 'SEO分析AI'
        self.category = 'seo_analysis'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': 'SEO健康检查，关键词建议', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.999269'}
