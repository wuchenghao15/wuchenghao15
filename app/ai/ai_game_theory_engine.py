...
博弈策略分析，纳什均衡
模块类别: game_theory
创建时间: 2026-07-29T21:05:36.167774
版本: 2.0.0
"""
...
class AiGameTheoryEngine:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_game_theory_engine'
        self.display_name = '博弈论引擎AI'
        self.category = 'game_theory'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '博弈策略分析，纳什均衡', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.167774'}
