...
留存引擎AI
留存策略优化，召回方案
模块类别: retention_engine
创建时间: 2026-07-29T21:05:36.122706
版本: 2.0.0
"""
...
class AiRetentionEngine:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_retention_engine'
        self.display_name = '留存引擎AI'
        self.category = 'retention_engine'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '留存策略优化，召回方案', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.122706'}
