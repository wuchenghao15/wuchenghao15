...
事故根因分析，改进建议
模块类别: postmortem
创建时间: 2026-07-29T21:05:36.047322
版本: 2.0.0
"""
...
class AiIncidentPostmortem:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_incident_postmortem'
        self.display_name = '事故分析AI'
        self.category = 'postmortem'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '事故根因分析，改进建议', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.047322'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiIncidentPostmortem()
    return _instance
