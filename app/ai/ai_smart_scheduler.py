...
创建时间: 2026-07-29T21:00:12.451633
版本: 1.0.0
"""
...
class AiSmartScheduler:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_smart_scheduler'
        self.display_name = '智能调度AI'
    ...
    def get_info(self):
        ...
        return {
            ...
            'display_name': self.display_name,
            'category': self.category,
            'description': '智能调度AI员工任务优先级',
            'version': self.version,
            'status': self.status,
            'created_at': '2026-07-29T21:00:12.451633'
        }
