...
性能审计AI
页面性能审计，优化建议
模块类别: performance_audit
创建时间: 2026-07-29T21:05:35.995601
版本: 2.0.0
"""
...
class AiPerformanceAuditor:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_performance_auditor'
        self.display_name = '性能审计AI'
        self.category = 'performance_audit'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '页面性能审计，优化建议', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.995601'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiPerformanceAuditor()
    return _instance
