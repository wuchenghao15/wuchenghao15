...
图像识别，OCR支持
模块类别: image_analysis
创建时间: 2026-07-29T21:05:35.914480
版本: 2.0.0
"""
...
class AiImageAnalyzer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_image_analyzer'
        self.display_name = '图像分析AI'
        self.category = 'image_analysis'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '图像识别，OCR支持', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.914480'}
