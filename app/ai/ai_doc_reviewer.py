...
文档审查AI
文档内容审查，格式检查
模块类别: document_review
创建时间: 2026-07-29T21:05:35.977218
版本: 2.0.0
"""
...
class AiDocReviewer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_doc_reviewer'
        self.display_name = '文档审查AI'
        self.category = 'document_review'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '文档内容审查，格式检查', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.977218'}
