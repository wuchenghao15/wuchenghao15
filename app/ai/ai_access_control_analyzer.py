...
权限分析，最小权限建议
模块类别: access_control
创建时间: 2026-07-29T21:05:35.774281
版本: 2.0.0
"""
...
class AiAccessControlAnalyzer:
    """访问控制分析AI - 权限分析，最小权限建议"""
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_access_control_analyzer'
        self.display_name = '访问控制分析AI'
        self.category = 'access_control'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '权限分析，最小权限建议', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.774281'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiAccessControlAnalyzer()
    return _instance
