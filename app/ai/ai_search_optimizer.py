...
搜索优化AI
搜索排序优化，意图理解
模块类别: search_optimization
创建时间: 2026-07-29T21:05:35.828295
版本: 2.0.0
"""
...
class AiSearchOptimizer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_search_optimizer'
        self.display_name = '搜索优化AI'
        self.category = 'search_optimization'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '搜索排序优化，意图理解', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.828295'}
