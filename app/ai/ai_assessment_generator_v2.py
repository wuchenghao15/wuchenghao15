...
评估生成AI v2
自动生成多维度评估方案，自适应测试
模块类别: assessment_generation
创建时间: 2026-07-29T21:05:35.714242
版本: 2.0.0
"""
...
class AiAssessmentGeneratorV2:
    """评估生成AI v2 - 自动生成多维度评估方案，自适应测试"""
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_assessment_generator_v2'
        self.display_name = '评估生成AI v2'
        self.category = 'assessment_generation'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '自动生成多维度评估方案，自适应测试', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.714242'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiAssessmentGeneratorV2()
    return _instance
