...
生命周期价值计算，客户分层
模块类别: ltv_engine
创建时间: 2026-07-29T21:05:36.111150
版本: 2.0.0
"""
...
class AiLtvEngine:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_ltv_engine'
        self.display_name = 'LTV引擎AI'
        self.category = 'ltv_engine'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '生命周期价值计算，客户分层', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.111150'}
