...
会议分析AI
会议效率分析，行动项提取
模块类别: meeting_analysis
创建时间: 2026-07-29T21:05:35.966063
版本: 2.0.0
"""
...
class AiMeetingAnalyzer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_meeting_analyzer'
        self.display_name = '会议分析AI'
        self.category = 'meeting_analysis'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '会议效率分析，行动项提取', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.966063'}
