...
创建时间: 2026-07-29T21:00:12.463211
版本: 1.0.0
"""
...
class AiSecurityAnalyzer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_security_analyzer'
        self.display_name = '安全分析AI'
    ...
    def get_info(self):
        ...
        return {
            ...
            'display_name': self.display_name,
            'category': self.category,
            'description': '分析系统安全状态，检测潜在威胁',
            'version': self.version,
            'status': self.status,
            'created_at': '2026-07-29T21:00:12.463211'
        }
