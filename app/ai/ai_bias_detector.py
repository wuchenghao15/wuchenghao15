...
算法偏见检测，公平性指标
模块类别: bias_detection
创建时间: 2026-07-29T21:05:36.229347
版本: 2.0.0
"""
...
class AiBiasDetector:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_bias_detector'
        self.display_name = '偏见检测AI'
        self.category = 'bias_detection'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '算法偏见检测，公平性指标', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.229347'}
