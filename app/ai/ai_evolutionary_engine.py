...
进化计算AI
遗传编程，进化策略
模块类别: evolutionary_computation
创建时间: 2026-07-29T21:05:36.186563
版本: 2.0.0
"""
...
class AiEvolutionaryEngine:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_evolutionary_engine'
        self.display_name = '进化计算AI'
        self.category = 'evolutionary_computation'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '遗传编程，进化策略', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.186563'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiEvolutionaryEngine()
    return _instance
