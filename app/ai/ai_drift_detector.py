...
漂移检测AI
数据漂移检测，概念漂移检测
模块类别: drift_detection
创建时间: 2026-07-29T21:05:36.213486
版本: 2.0.0
"""
...
class AiDriftDetector:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_drift_detector'
        self.display_name = '漂移检测AI'
        self.category = 'drift_detection'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '数据漂移检测，概念漂移检测', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.213486'}
