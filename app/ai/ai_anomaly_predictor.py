...
异常预测AI
异常事件预测，提前预警
模块类别: anomaly_prediction
创建时间: 2026-07-29T21:05:35.868036
版本: 2.0.0
"""
...
class AiAnomalyPredictor:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_anomaly_predictor'
        self.display_name = '异常预测AI'
        self.category = 'anomaly_prediction'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '异常事件预测，提前预警', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.868036'}
