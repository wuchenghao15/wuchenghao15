...
部署顾问AI
部署策略建议，灰度发布分析
模块类别: deployment_advisory
创建时间: 2026-07-29T21:05:35.789542
版本: 2.0.0
"""
...
class AiDeploymentAdvisor:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_deployment_advisor'
        self.display_name = '部署顾问AI'
        self.category = 'deployment_advisory'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '部署策略建议，灰度发布分析', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.789542'}
