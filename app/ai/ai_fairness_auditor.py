...
模型公平性检查，偏见检测
模块类别: fairness_audit
创建时间: 2026-07-29T21:05:36.225309
版本: 2.0.0
"""
...
class AiFairnessAuditor:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_fairness_auditor'
        self.display_name = '公平性审计AI'
        self.category = 'fairness_audit'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '模型公平性检查，偏见检测', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.225309'}
