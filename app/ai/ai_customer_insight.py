...
客户洞察AI
客户画像分析，需求挖掘
模块类别: customer_insight
创建时间: 2026-07-29T21:05:36.008980
版本: 2.0.0
"""
...
class AiCustomerInsight:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_customer_insight'
        self.display_name = '客户洞察AI'
        self.category = 'customer_insight'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '客户画像分析，需求挖掘', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.008980'}
