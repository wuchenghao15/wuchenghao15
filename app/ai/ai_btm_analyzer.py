...
BPMN流程分析，优化建议
模块类别: btm_analysis
创建时间: 2026-07-29T21:05:35.891759
版本: 2.0.0
"""
...
class AiBtmAnalyzer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_btm_analyzer'
        self.display_name = '业务流程分析AI'
        self.category = 'btm_analysis'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': 'BPMN流程分析，优化建议', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.891759'}
