...
评估设计AI
评估方案设计，题目生成
模块类别: assessment_design
创建时间: 2026-07-29T21:05:36.065892
版本: 2.0.0
"""
...
class AiAssessmentDesigner:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_assessment_designer'
        self.display_name = '评估设计AI'
        self.category = 'assessment_design'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '评估方案设计，题目生成', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.065892'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiAssessmentDesigner()
    return _instance
