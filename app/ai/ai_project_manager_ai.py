...
项目管理AI
项目进度分析，风险预测
模块类别: project_management
创建时间: 2026-07-29T21:05:35.955480
版本: 2.0.0
"""
...
class AiProjectManagerAi:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_project_manager_ai'
        self.display_name = '项目管理AI'
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '项目进度分析，风险预测', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.955480'}
