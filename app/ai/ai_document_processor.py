...
文档处理AI
文档解析，结构化提取
模块类别: document_processing
创建时间: 2026-07-29T21:05:35.921385
版本: 2.0.0
"""
...
class AiDocumentProcessor:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_document_processor'
        self.display_name = '文档处理AI'
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '文档解析，结构化提取', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.921385'}
