...
指标聚合AI
指标聚合，异常检测
模块类别: metrics_aggregation
创建时间: 2026-07-29T21:05:36.040785
版本: 2.0.0
"""
...
class AiMetricsAggregator:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_metrics_aggregator'
        self.display_name = '指标聚合AI'
        self.category = 'metrics_aggregation'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '指标聚合，异常检测', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.040785'}
