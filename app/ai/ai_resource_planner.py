...
资源规划AI
资源使用规划，效率提升
模块类别: resource_planning
创建时间: 2026-07-29T21:05:35.880447
版本: 2.0.0
"""
...
class AiResourcePlanner:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_resource_planner'
        self.display_name = '资源规划AI'
        self.category = 'resource_planning'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '资源使用规划，效率提升', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.880447'}
