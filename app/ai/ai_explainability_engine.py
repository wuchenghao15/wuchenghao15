...
模型解释，SHAP/LIME
模块类别: explainability
创建时间: 2026-07-29T21:05:36.221738
版本: 2.0.0
"""
...
class AiExplainabilityEngine:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_explainability_engine'
        self.display_name = '可解释性AI'
        self.category = 'explainability'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '模型解释，SHAP/LIME', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.221738'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiExplainabilityEngine()
    return _instance
