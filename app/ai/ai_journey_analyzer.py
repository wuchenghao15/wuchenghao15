...
旅程分析AI
用户旅程分析，触点优化
模块类别: journey_analysis
创建时间: 2026-07-29T21:05:36.097030
版本: 2.0.0
"""
...
class AiJourneyAnalyzer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_journey_analyzer'
        self.display_name = '旅程分析AI'
        self.category = 'journey_analysis'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '用户旅程分析，触点优化', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.097030'}
