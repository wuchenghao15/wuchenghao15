...
多触点归因分析，营销ROI计算
模块类别: attribution
创建时间: 2026-07-29T21:05:35.817154
版本: 2.0.0
"""
...
class AiAttributionAnalyzer:
    """归因分析AI - 多触点归因分析，营销ROI计算"""
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_attribution_analyzer'
        self.display_name = '归因分析AI'
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '多触点归因分析，营销ROI计算', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.817154'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiAttributionAnalyzer()
    return _instance
