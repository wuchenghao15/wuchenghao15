...
导师匹配AI
导师匹配，知识传承
模块类别: mentor_matching
创建时间: 2026-07-29T21:05:36.082810
版本: 2.0.0
"""
...
class AiMentorMatcher:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_mentor_matcher'
        self.display_name = '导师匹配AI'
        self.category = 'mentor_matching'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '导师匹配，知识传承', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.082810'}
