...
业务模拟，决策支持
模块类别: simulation
创建时间: 2026-07-29T21:05:36.149455
版本: 2.0.0
"""
...
class AiSimulationEngine:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_simulation_engine'
        self.display_name = '模拟引擎AI'
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '业务模拟，决策支持', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.149455'}
