...
创建时间: 2026-07-29T21:00:12.466769
版本: 1.0.0
"""
...
class AiPerformanceTuner:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_performance_tuner'
        self.display_name = '性能调优AI'
    ...
    def get_info(self):
        ...
        return {
            ...
            'display_name': self.display_name,
            'category': self.category,
            'description': '自动调优系统性能参数',
            'version': self.version,
            'status': self.status,
            'created_at': '2026-07-29T21:00:12.466769'
        }
