...
创建时间: 2026-07-29T21:00:12.439421
版本: 1.0.0
"""
...
class AiContentModerator:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_content_moderator'
        self.display_name = '内容审核AI'
    ...
    def get_info(self):
        ...
        return {
            ...
            'display_name': self.display_name,
            'category': self.category,
            'description': '智能审核用户生成内容，过滤不当信息',
            'version': self.version,
            'status': self.status,
            'created_at': '2026-07-29T21:00:12.439421'
        }
