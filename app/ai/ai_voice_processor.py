...
语音处理AI
语音识别，合成支持
模块类别: voice_processing
创建时间: 2026-07-29T21:05:35.910549
版本: 2.0.0
"""
...
class AiVoiceProcessor:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_voice_processor'
        self.display_name = '语音处理AI'
        self.category = 'voice_processing'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '语音识别，合成支持', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.910549'}
