...
创建时间: 2026-07-29T21:00:12.505003
版本: 1.0.0
"""
...
class AiAssessmentGenerator:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_assessment_generator'
        self.display_name = '评估生成AI'
    ...
    def get_info(self):
        ...
        return {
            ...
            'display_name': self.display_name,
            'category': self.category,
            'description': '自动生成多维度评估方案',
            'version': self.version,
            'status': self.status,
            'created_at': '2026-07-29T21:00:12.505003'
        }
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiAssessmentGenerator()
    return _instance
