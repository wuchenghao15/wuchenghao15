...
容量规划AI
容量需求预测，扩容建议
模块类别: capacity_planning
创建时间: 2026-07-29T21:05:35.873354
版本: 2.0.0
"""
...
class AiCapacityPlanner:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_capacity_planner'
        self.display_name = '容量规划AI'
        self.category = 'capacity_planning'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '容量需求预测，扩容建议', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.873354'}
