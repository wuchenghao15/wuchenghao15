...
日历优化AI
日程智能安排，冲突检测
模块类别: calendar_optimization
创建时间: 2026-07-29T21:05:35.973361
版本: 2.0.0
"""
...
class AiCalendarOptimizer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_calendar_optimizer'
        self.display_name = '日历优化AI'
        self.category = 'calendar_optimization'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '日程智能安排，冲突检测', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.973361'}
