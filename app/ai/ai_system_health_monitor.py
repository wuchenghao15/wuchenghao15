...
系统健康监控AI
7x24小时监控系统健康状态，实时告警
模块类别: health_monitoring
创建时间: 2026-07-29T21:05:35.723111
版本: 2.0.0
"""
...
class AiSystemHealthMonitor:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_system_health_monitor'
        self.display_name = '系统健康监控AI'
        self.category = 'health_monitoring'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '7x24小时监控系统健康状态，实时告警', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.723111'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiSystemHealthMonitor()
    return _instance
