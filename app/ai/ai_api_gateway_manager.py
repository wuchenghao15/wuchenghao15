...
API网关流量管理，限流熔断
模块类别: api_management
创建时间: 2026-07-29T21:05:35.733377
版本: 2.0.0
"""
...
class AiApiGatewayManager:
    """API网关管理AI - API网关流量管理，限流熔断"""
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_api_gateway_manager'
        self.display_name = 'API网关管理AI'
        self.category = 'api_management'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': 'API网关流量管理，限流熔断', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.733377'}
