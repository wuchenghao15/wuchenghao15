...
活动优化AI
营销活动优化，实时调整
模块类别: campaign_optimization
创建时间: 2026-07-29T21:05:35.856727
版本: 2.0.0
"""
...
class AiCampaignOptimizer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_campaign_optimizer'
        self.display_name = '活动优化AI'
        self.category = 'campaign_optimization'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '营销活动优化，实时调整', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.856727'}
