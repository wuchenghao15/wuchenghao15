...
培训分析AI
培训效果分析，能力画像
模块类别: training_analysis
创建时间: 2026-07-29T21:05:36.055873
版本: 2.0.0
"""
...
class AiTrainingAnalyzer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_training_analyzer'
        self.display_name = '培训分析AI'
        self.category = 'training_analysis'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '培训效果分析，能力画像', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.055873'}
