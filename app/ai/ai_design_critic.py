...
UI/UX设计评审，可用性检查
模块类别: design_critic
创建时间: 2026-07-29T21:05:35.988999
版本: 2.0.0
"""
...
class AiDesignCritic:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_design_critic'
        self.display_name = '设计评审AI'
        self.category = 'design_critic'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': 'UI/UX设计评审，可用性检查', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.988999'}
