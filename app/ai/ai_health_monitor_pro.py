...
健康监控专业版
设备健康评分，预测性告警
模块类别: health_monitoring_pro
创建时间: 2026-07-29T21:05:36.032849
版本: 2.0.0
"""
...
class AiHealthMonitorPro:
    """健康监控专业版 - 设备健康评分，预测性告警"""
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_health_monitor_pro'
        self.display_name = '健康监控专业版'
        self.category = 'health_monitoring_pro'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '设备健康评分，预测性告警', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.032849'}
