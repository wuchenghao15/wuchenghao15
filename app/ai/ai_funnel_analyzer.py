...
漏斗分析AI
转化漏斗分析，流失点定位
模块类别: funnel_analysis
创建时间: 2026-07-29T21:05:36.138025
版本: 2.0.0
"""
...
class AiFunnelAnalyzer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_funnel_analyzer'
        self.display_name = '漏斗分析AI'
        self.category = 'funnel_analysis'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '转化漏斗分析，流失点定位', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.138025'}
