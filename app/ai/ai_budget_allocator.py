...
预算分配AI
智能预算分配，ROI最大化
模块类别: budget_allocation
创建时间: 2026-07-29T21:05:35.860452
版本: 2.0.0
"""
...
class AiBudgetAllocator:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_budget_allocator'
        self.display_name = '预算分配AI'
        self.category = 'budget_allocation'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '智能预算分配，ROI最大化', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.860452'}
