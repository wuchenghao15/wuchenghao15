...
模型监控AI
模型性能监控，数据漂移检测
模块类别: model_monitoring
创建时间: 2026-07-29T21:05:36.209794
版本: 2.0.0
"""
...
class AiModelMonitor:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_model_monitor'
        self.display_name = '模型监控AI'
        self.category = 'model_monitoring'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '模型性能监控，数据漂移检测', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.209794'}
