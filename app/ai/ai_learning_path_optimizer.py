...
创建时间: 2026-07-29T21:00:12.501414
版本: 1.0.0
"""
...
class AiLearningPathOptimizer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_learning_path_optimizer'
        self.display_name = '学习路径优化AI'
    ...
    def get_info(self):
        ...
        return {
            ...
            'display_name': self.display_name,
            'category': self.category,
            'description': '动态优化学习路径推荐',
            'version': self.version,
            'status': self.status,
            'created_at': '2026-07-29T21:00:12.501414'
        }
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiLearningPathOptimizer()
    return _instance
