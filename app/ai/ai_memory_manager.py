...
内存管理AI
内存使用分析，泄漏检测
模块类别: memory_management
创建时间: 2026-07-29T21:05:35.740526
版本: 2.0.0
"""
...
class AiMemoryManager:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_memory_manager'
        self.display_name = '内存管理AI'
        self.category = 'memory_management'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '内存使用分析，泄漏检测', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.740526'}
