...
加密审计AI
加密强度检查，密钥管理建议
模块类别: encryption_audit
创建时间: 2026-07-29T21:05:35.779237
版本: 2.0.0
"""
...
class AiEncryptionAuditor:
    """加密审计AI - 加密强度检查，密钥管理建议"""
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_encryption_auditor'
        self.display_name = '加密审计AI'
        self.category = 'encryption_audit'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '加密强度检查，密钥管理建议', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.779237'}
