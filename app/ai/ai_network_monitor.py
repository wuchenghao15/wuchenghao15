...
网络监控AI
网络状态监控，异常流量检测
模块类别: network_monitoring
创建时间: 2026-07-29T21:05:35.744255
版本: 2.0.0
"""
...
class AiNetworkMonitor:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_network_monitor'
        self.display_name = '网络监控AI'
        self.category = 'network_monitoring'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '网络状态监控，异常流量检测', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.744255'}
