...
流失预测AI
用户流失预测，挽留策略建议
模块类别: churn_prediction
创建时间: 2026-07-29T21:05:35.801496
版本: 2.0.0
"""
...
class AiChurnPredictor:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_churn_predictor'
        self.display_name = '流失预测AI'
        self.category = 'churn_prediction'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '用户流失预测，挽留策略建议', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.801496'}
