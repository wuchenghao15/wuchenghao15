...
合同分析AI
合同条款分析，风险点标记
模块类别: contract_analysis
创建时间: 2026-07-29T21:05:36.025801
版本: 2.0.0
"""
...
class AiContractAnalyzer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_contract_analyzer'
        self.display_name = '合同分析AI'
        self.category = 'contract_analysis'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '合同条款分析，风险点标记', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.025801'}
