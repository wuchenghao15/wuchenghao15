...
流失预警，挽留策略
模块类别: churn_engine
创建时间: 2026-07-29T21:05:36.114778
版本: 2.0.0
"""
...
class AiChurnEngine:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_churn_engine'
        self.display_name = '流失引擎AI'
        self.category = 'churn_engine'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '流失预警，挽留策略', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.114778'}
