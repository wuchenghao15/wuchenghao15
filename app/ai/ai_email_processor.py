...
邮件处理AI
邮件分类，自动回复建议
模块类别: email_processing
创建时间: 2026-07-29T21:05:35.969597
版本: 2.0.0
"""
...
class AiEmailProcessor:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_email_processor'
        self.display_name = '邮件处理AI'
        self.category = 'email_processing'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '邮件分类，自动回复建议', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.969597'}
