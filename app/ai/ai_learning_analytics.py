...
学习分析AI
学习行为分析，个性化建议
模块类别: learning_analytics
创建时间: 2026-07-29T21:05:36.072761
版本: 2.0.0
"""
...
class AiLearningAnalytics:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_learning_analytics'
        self.display_name = '学习分析AI'
        self.category = 'learning_analytics'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '学习行为分析，个性化建议', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.072761'}
