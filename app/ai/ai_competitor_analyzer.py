...
竞品分析AI
竞品对比，差异化建议
模块类别: competitor_analysis
创建时间: 2026-07-29T21:05:36.002445
版本: 2.0.0
"""
...
class AiCompetitorAnalyzer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_competitor_analyzer'
        self.display_name = '竞品分析AI'
        self.category = 'competitor_analysis'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '竞品对比，差异化建议', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.002445'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiCompetitorAnalyzer()
    return _instance
