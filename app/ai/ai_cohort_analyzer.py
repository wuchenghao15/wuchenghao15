...
队列分析AI
队列留存分析，同期群对比
模块类别: cohort_analysis
创建时间: 2026-07-29T21:05:36.141816
版本: 2.0.0
"""
...
class AiCohortAnalyzer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_cohort_analyzer'
        self.display_name = '队列分析AI'
        self.category = 'cohort_analysis'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '队列留存分析，同期群对比', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.141816'}
