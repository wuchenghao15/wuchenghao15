...
时间序列预测，趋势分析
模块类别: forecasting
创建时间: 2026-07-29T21:05:35.864579
版本: 2.0.0
"""
...
class AiForecastEngine:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_forecast_engine'
        self.display_name = '预测引擎AI'
        self.category = 'forecasting'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '时间序列预测，趋势分析', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.864579'}
