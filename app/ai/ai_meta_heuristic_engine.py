...
遗传算法，模拟退火，禁忌搜索
模块类别: metaheuristic
创建时间: 2026-07-29T21:05:36.175132
版本: 2.0.0
"""
...
class AiMetaHeuristicEngine:
    """元启发式AI - 遗传算法，模拟退火，禁忌搜索"""
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_meta_heuristic_engine'
        self.display_name = '元启发式AI'
        self.category = 'metaheuristic'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '遗传算法，模拟退火，禁忌搜索', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.175132'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiMetaHeuristicEngine()
    return _instance
