...
学习路径优化AI v2
动态优化学习路径推荐，能力画像分析
模块类别: path_optimization
创建时间: 2026-07-29T21:05:35.709826
版本: 2.0.0
"""
...
class AiLearningPathOptimizerV2:
    """学习路径优化AI v2 - 动态优化学习路径推荐，能力画像分析"""
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_learning_path_optimizer_v2'
        self.display_name = '学习路径优化AI v2'
        self.category = 'path_optimization'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '动态优化学习路径推荐，能力画像分析', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.709826'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiLearningPathOptimizerV2()
    return _instance
