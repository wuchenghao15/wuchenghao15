...
创建时间: 2026-07-29T21:00:12.447701
版本: 1.0.0
"""
...
class AiAnomalyDetector:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_anomaly_detector'
        self.display_name = '异常检测AI'
    ...
    def get_info(self):
        ...
        return {
            ...
            'display_name': self.display_name,
            'category': self.category,
            'description': '实时检测系统异常行为并预警',
            'version': self.version,
            'status': self.status,
            'created_at': '2026-07-29T21:00:12.447701'
        }
