...
社交监听AI
社交媒体监听，趋势发现
模块类别: social_listening
创建时间: 2026-07-29T21:05:35.849258
版本: 2.0.0
"""
...
class AiSocialListener:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_social_listener'
        self.display_name = '社交监听AI'
        self.category = 'social_listening'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '社交媒体监听，趋势发现', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.849258'}
