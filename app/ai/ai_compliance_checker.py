...
合规性检查，审计日志生成
模块类别: compliance
创建时间: 2026-07-29T21:05:35.769038
版本: 2.0.0
"""
...
class AiComplianceChecker:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_compliance_checker'
        self.display_name = '合规检查AI'
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '合规性检查，审计日志生成', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.769038'}
