...
影响力评分AI
KOL影响力分析，合作建议
模块类别: influencer_scoring
创建时间: 2026-07-29T21:05:35.852824
版本: 2.0.0
"""
...
class AiInfluencerScorer:
    """影响力评分AI - KOL影响力分析，合作建议"""
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_influencer_scorer'
        self.display_name = '影响力评分AI'
        self.category = 'influencer_scoring'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': 'KOL影响力分析，合作建议', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.852824'}
