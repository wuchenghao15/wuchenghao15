...
自动审查代码质量，提供改进建议
模块类别: code_review
创建时间: 2026-07-29T21:00:12.490902
版本: 1.0.0
"""
...
class AiCodeQualityReviewer:
    """代码质量审查AI - 自动审查代码质量，提供改进建议"""
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_code_quality_reviewer'
        self.display_name = '代码质量审查AI'
    ...
    def get_info(self):
        ...
        return {
            ...
            'version': self.version,
            'status': self.status,
            'created_at': '2026-07-29T21:00:12.490902'
        }
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiCodeQualityReviewer()
    return _instance
