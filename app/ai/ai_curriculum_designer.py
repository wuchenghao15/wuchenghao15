...
课程设计AI
课程体系设计，知识点规划
模块类别: curriculum_design
创建时间: 2026-07-29T21:05:36.069337
版本: 2.0.0
"""
...
class AiCurriculumDesigner:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_curriculum_designer'
        self.display_name = '课程设计AI'
        self.category = 'curriculum_design'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '课程体系设计，知识点规划', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.069337'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiCurriculumDesigner()
    return _instance
