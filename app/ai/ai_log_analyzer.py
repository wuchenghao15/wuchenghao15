...
智能分析系统日志，异常模式识别
模块类别: log_analysis
创建时间: 2026-07-29T21:05:35.726371
版本: 2.0.0
"""
...
class AiLogAnalyzer:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_log_analyzer'
        self.display_name = '日志分析AI'
        self.category = 'log_analysis'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '智能分析系统日志，异常模式识别', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.726371'}
