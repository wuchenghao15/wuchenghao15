...
多目标优化AI
多目标优化，Pareto分析
模块类别: multi_objective_optimization
创建时间: 2026-07-29T21:05:36.160307
版本: 2.0.0
"""
...
class AiMultiObjectiveOptimizer:
    """多目标优化AI - 多目标优化，Pareto分析"""
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_multi_objective_optimizer'
        self.display_name = '多目标优化AI'
        self.category = 'multi_objective_optimization'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '多目标优化，Pareto分析', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.160307'}
...
def get_instance():
    ...
    if _instance is None:
        _instance = AiMultiObjectiveOptimizer()
    return _instance
