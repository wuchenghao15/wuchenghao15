...
实时语音转写，多语言支持
模块类别: speech_to_text
创建时间: 2026-07-29T21:05:35.931694
版本: 2.0.0
"""
...
class AiSpeechToText:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_speech_to_text'
        self.display_name = '语音转文字AI'
        self.category = 'speech_to_text'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '实时语音转写，多语言支持', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.931694'}
