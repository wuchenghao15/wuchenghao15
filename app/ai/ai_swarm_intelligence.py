...
群体智能AI
粒子群优化，蚁群算法
模块类别: swarm_intelligence
创建时间: 2026-07-29T21:05:36.180668
版本: 2.0.0
"""
...
class AiSwarmIntelligence:
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_swarm_intelligence'
        self.display_name = '群体智能AI'
        self.category = 'swarm_intelligence'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': '粒子群优化，蚁群算法', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:36.180668'}
