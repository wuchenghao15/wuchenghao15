...
A/B实验设计，样本量计算
模块类别: ab_test_design
创建时间: 2026-07-29T21:05:35.813284
版本: 2.0.0
"""
...
class AiAbTestDesigner:
    """实验设计AI - A/B实验设计，样本量计算"""
    ...
    def __init__(self, db_path=None):
        ...
        self.module_name = 'ai_ab_test_designer'
        self.display_name = '实验设计AI'
        self.category = 'ab_test_design'
        self.version = '2.0.0'
        self.status = 'active'
        self._init_db()
    ...
    def get_info(self):
        return {'module_name': self.module_name, 'display_name': self.display_name, 'category': self.category, 'description': 'A/B实验设计，样本量计算', 'version': self.version, 'status': self.status, 'created_at': '2026-07-29T21:05:35.813284'}
